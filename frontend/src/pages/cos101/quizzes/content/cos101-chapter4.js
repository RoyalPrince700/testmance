// Quiz data for COS 101 Chapter 4: Diverse and Growing Computers and Digital Applications
// Questions generated from the actual chapter content

export const cos101Chapter4Quiz = {
  title: 'COS 101 Chapter 4: Diverse and Growing Computers and Digital Applications',
  description: 'Comprehensive test of diverse computing technologies, digital applications, information processing, and emerging trends in computing',
  courseCode: 'COS 101',
  chapterTitle: 'Diverse and Growing Computers and Digital Applications',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'What does "Diverse and Growing Computers" primarily refer to?',
      options: [
        'Only different types of computer hardware',
        'The wide range of computing devices and increasing representation of underrepresented groups in technology',
        'Just the evolution of computer software',
        'Only the economic aspects of computing'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The variety of computer brands available',
        'The range of different types of elements in a dataset',
        'The diversity of computer users',
    ...
    {
      question: 'Which of the following is an example of educational digital applications?',
      options: [
        'Duolingo',
        'Netflix',
        'Spotify',
    ...
    },
    {
      ...
      options: [
        'A type of medical robot',
        'Remote healthcare delivery using digital technology',
    ...
    },
    {
      ...
      options: [
        'Only storing data',
        'Collection, storage, retrieval, manipulation, and dissemination of information',
    ...
    },
    {
      ...
      options: [
        ...
        'Complete elimination of all jobs'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'Information Programming System'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Permanent software stored in non-volatile memory',
    ...
    },
    {
      ...
      options: [
        ...
        'To enable informed decisions in various sectors',
        'To slow down decision processes',
    ...
    },
    {
      ...
      options: [
        ...
        'Better word processing capabilities',
        'Improved internet browsing',
        'Enhanced spreadsheet calculations only'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Reduced software options',
        'Eliminated networking needs'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'It leads to better innovation, productivity, and products that serve diverse markets',
        'It reduces the number of available technologies',
        'It makes computing more complicated'
      ],
      correctAnswer: 1,

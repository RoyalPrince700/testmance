// Quiz data for COS 101 Chapter 5: The Internet: Its Application and Impact on the World Today
// Questions generated from the actual chapter content

export const cos101Chapter5Quiz = {
  title: 'COS 101 Chapter 5: The Internet: Its Application and Impact on the World Today',
  description: 'Comprehensive test of internet history, applications, societal impact, and computing discipline areas',
  courseCode: 'COS 101',
  chapterTitle: 'The Internet: Its Application and Impact on the World Today',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'When was ARPANET established and what was its primary purpose?',
      options: [
        '1950s for commercial purposes',
        '1960s for military and academic research communication',
        '1970s for entertainment purposes',
        '1980s for business applications'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Internet Protocol (IP) was developed',
        'Social media platforms emerged',
        'Mobile internet became available'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'What is e-government and what does it provide?',
      options: [
        'Electronic voting machines',
        'Online access to government services, licenses, and permits',
        'Government-owned social media accounts',
        'Digital currency issued by governments'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'High Computing Interface',
        'Human-Computer Interaction',
        'Hardware Control Interface',
        'Hypertext Computer Integration'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Protecting computer systems and data from unauthorized access',
    ...
    },
    {
      ...
      options: [
        'It replaces all physical computers',
        'It enables remote data storage, processing, and collaboration',
        'It only works for gaming applications',
    ...
    },
    {
      ...
      options: [
        'It eliminates all physical stores',
        'It allows online shopping, digital payments, and entrepreneurship',
        'It only works for large businesses',
        'It replaces all traditional banking'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It forces people to stay indoors',
        'It can reduce face-to-face interactions and relationships',
        'It eliminates all forms of communication',
    ...
    },
    {
      ...
      options: [
        ...
        'It contributes to electronic waste and energy consumption',
        'It destroys natural habitats directly',
    ...
    },
    {
      ...
      options: [
        ...
        'Its potential remains immense and continues to shape the world',
        'It only benefits developed countries',
        'It will be replaced by newer technologies soon'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Only a few are important for modern technology',
    ...
    },
    {
      ...
      options: [
        'Internet Relay Chat, introduced in the 1970s',
        'Internet Relay Chat, introduced in the 1980s',
        'Internet Resource Center, introduced in the 1990s',
        'Internet Research Center, introduced in the 2000s'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It made internet access mobile',
        'It brought connectivity to homes',
    ...
    },
    {
      ...
      options: [
        'Connecting everyday devices to the internet',
        'Creating video games',
        'Writing documents',
    ...
    },
    {
      ...
      options: [
        'They are more expensive than physical classrooms',
        'They provide access to education from anywhere in the world',
        'They only work for advanced students',
        'They replace all physical education'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only online voting',
        'Online voting systems, public forums, and participatory governance',
        'Only government surveillance',
    ...
    },
    {
      ...
      options: [
        'They are more expensive than paper records',
        'They ensure confidential and efficient healthcare management',
        'They only work in developed countries',
        'They replace all medical professionals'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It eliminates the need for physical bank branches',
        'It enables mobile banking, digital payments, and financial transactions',
        'It only works for large corporations',
        'It replaces all traditional financial systems'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Digital tracking, logistics, and inventory management',
        'Only manual record keeping',
        'Only local deliveries'
      ],
      correctAnswer: 1,

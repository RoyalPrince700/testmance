// Quiz data for COS 101 Chapter 6: Job Specializations and Future of Computing
// Questions generated from the actual chapter content

export const cos101Chapter6Quiz = {
  title: 'COS 101 Chapter 6: Job Specializations and Future of Computing',
  description: 'Comprehensive test of computing career paths, job specializations, and emerging technologies shaping the future of computing',
  courseCode: 'COS 101',
  chapterTitle: 'Job Specializations and Future of Computing',
  passingScore: 70,
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        'Analyzes target audiences to understand user behavior with digital programs',
    ...
    
    {
      ...
      options: [
        ...
        'A form of distributed computing where resources are shared via the internet',
    ...
    },
    {
      ...
      options: [
        ...
        'A technology that links physical objects to the internet for real-time interaction',
    ...
    },
    {
      ...
      options: [
        ...
        'Ability to solve complex problems that traditional computers cannot',
        'Lower cost',
        'Easier programming'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Making computers larger',
        'Better user experience, connectivity, and performance',
        'Removing all software',
        'Eliminating internet connectivity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'By providing increased speed and reliability',
        'By reducing internet access',
        'By eliminating wireless connections'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Cost-efficient automation of tasks and improved accuracy',
        'Elimination of all technology use',
    ...
    },
    {
      ...
      options: [
        'Ignores security incidents',
        'Develops procedures to respond to emergencies and restore digital assets',
        'Deletes all company data',
        'Shares confidential information publicly'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Creating visual elements and testing game functionality',
    ...
    },
    {
      ...
      options: [
        'Shares data with unauthorized users',
        'Ensures structures work effectively and installs security procedures',
        'Deletes all stored data regularly',
        'Ignores security threats'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They only work on one aspect of development',
        'They can handle all aspects from UI design to database management',
        'They specialize in hardware only',
    ...
    },
    {
      ...
      options: [
        'They make apps slower',
        'They allow building apps for both iOS and Android with a single codebase',
    ...
    },
    {
      ...
      options: [
        ...
        'Installing safeguards and monitoring network performance',
        'Sharing network access widely',
    ...
    },
    {
      ...
      options: [
        'By requiring expensive hardware purchases',
        'By providing scalable resources and remote access without hardware investment',
        'By limiting data storage options',
        'By reducing internet connectivity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only entertainment industry',
        'Healthcare, finance, retail, education, and more',
        'Only manufacturing',
        'Only agriculture'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'By making devices less efficient',
        'By allowing remote control and automated cycles',
        'By eliminating device connectivity',
        'By requiring physical presence always'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They use qubits for parallel processing of multiple possibilities',
    ...
    },
    {
      ...
      options: [
        ...
        'Elimination of wireless networks',
    ...
    },
    {
      ...
      options: [
        'It will eliminate all human jobs',
        'It will integrate into industries and everyday life for enhanced capabilities',
        'It will make technology more complicated',
        'It will reduce technological progress'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'By increasing manual labor needs',
        'By automating tasks and freeing resources previously spent on manual work',
        'By eliminating the need for computers',
        'By making processes more expensive'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Enhance cloud computing, IoT, and connectivity',
        'Eliminate wireless technology',
        'Make devices less connected'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It uses traditional bits only',
        'It can solve complex optimization and simulation problems',
        'It is slower than classical computers',
        'It cannot perform parallel processing'
      ],
      correctAnswer: 1,

      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-blue-50 border-l-4 border-blue-500 p-4 my-4">
            <p class="font-semibold text-blue-900 mb-2">🎯 Key Purpose</p>
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-gray-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 mb-3">Core Concept:</h4>
          ...
          <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 my-4">
            <p class="font-semibold text-yellow-900 mb-2">✨ Importance</p>
        ...
        <div class="space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 my-6">
            <div class="bg-red-50 p-5 rounded-lg border border-red-200">
              <h4 class="font-bold text-red-900 mb-2">❌ Null Hypothesis (H₀)</h4>
              <p class="text-red-800 mb-3">The hypothesis of "no effect" or "no difference"</p>
            ...
            <div class="bg-green-50 p-5 rounded-lg border border-green-200">
              <h4 class="font-bold text-green-900 mb-2">✅ Alternative Hypothesis (H₁)</h4>
              <p class="text-green-800 mb-3">The hypothesis of interest or research hypothesis</p>
          ...
          <div class="bg-indigo-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-indigo-900 mb-3">Key Characteristics:</h4>
            <div class="space-y-3">
              <div class="flex items-start">
                <span class="text-indigo-500 mr-3 font-bold">1.</span>
                <div>
                  <strong class="text-indigo-900">Mutually Exclusive:</strong> Both hypotheses cannot be true at the same time
                </div>
              </div>
              <div class="flex items-start">
                <span class="text-indigo-500 mr-3 font-bold">2.</span>
                <div>
                  <strong class="text-indigo-900">Exhaustive:</strong> They cover all possible truths about the relationship
                </div>
              </div>
              <div class="flex items-start">
                <span class="text-indigo-500 mr-3 font-bold">3.</span>
                <div>
                  <strong class="text-indigo-900">Mathematically Stated:</strong> Usually expressed in mathematical terms
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4 my-6">
            <div class="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
              <h4 class="font-bold text-blue-900 mb-3">Two-Tail Test Example</h4>
              <p class="text-blue-800 mb-3"><strong>Research Question:</strong> "Is the average performance of students in a CBT GNS examination different from their average performance in an MBT GNS examination?"</p>
            ...
            <div class="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
              <h4 class="font-bold text-green-900 mb-3">One-Tail Test Examples</h4>
              <div class="space-y-3">
    ...
    },
    {
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 my-6">
            <div class="bg-red-50 p-5 rounded-lg border border-red-200">
              <h4 class="font-bold text-red-900 mb-2">❌ Type I Error (α)</h4>
              <p class="text-red-800 mb-3">Rejecting H₀ when H₀ is actually true</p>
              <ul class="space-y-1 text-sm text-red-700">
          ...
          <div class="bg-green-50 p-5 rounded-lg border border-green-200 my-4">
            <h4 class="font-bold text-green-900 mb-2">✅ Power (1 - β)</h4>
            <p class="text-green-800 mb-3">The probability of correctly rejecting H₀ when H₀ is false</p>
            <ul class="space-y-1 text-sm text-green-700">
          ...
          <div class="bg-gray-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 mb-3">Confusion Matrix:</h4>
    ...
    },
    {
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-teal-50 border-l-4 border-teal-500 p-4 my-4">
            <p class="font-semibold text-teal-900 mb-2">🎯 The Logic</p>
            <p class="text-teal-800">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4 my-6">
            <div class="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
              ...
              <p class="text-blue-800 mb-3">Define what you want to investigate</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
              ...
              <p class="text-green-800 mb-3">Formulate H₀ and H₁</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
              ...
              <p class="text-purple-800 mb-3">Select appropriate statistical test</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
              ...
              <p class="text-yellow-800 mb-3">Make decision about H₀</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
              ...
              <p class="text-red-800 mb-3">Interpret results in context</p>
              <div class="bg-white p-3 rounded">
        ...
        <div class="space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 my-6">
            <div class="bg-indigo-50 p-5 rounded-lg border border-indigo-200">
              <h4 class="font-bold text-indigo-900 mb-2">🎲 Random Sampling</h4>
              <p class="text-indigo-800 mb-3">Sample must be randomly selected from population</p>
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-green-50 border-l-4 border-green-500 p-4 my-4">
            <p class="font-semibold text-green-900 mb-2">🛠️ Engineering Context</p>
    ...
    },
    {
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-gray-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 mb-3">Step 1: State the Research Question</h4>
            <p class="text-gray-700">Does the lubricant reduce mean wear diameter below 675 μm?</p>
          </div>

          <div class="bg-blue-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-blue-900 mb-3">Step 2: Specify Hypotheses</h4>
            <div class="space-y-2">
              <p class="text-blue-800"><strong>H₀:</strong> μ ≥ 675 μm (lubricant does not meet specification)</p>
              <p class="text-blue-800"><strong>H₁:</strong> μ < 675 μm (lubricant meets specification)</p>
            </div>
          </div>

          <div class="bg-green-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-green-900 mb-3">Step 3: Choose Test Statistic</h4>
            <p class="text-green-800 mb-2">We use the one-sample t-test:</p>
          ...
          <div class="bg-purple-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-purple-900 mb-3">Step 4: Determine Critical Value</h4>
            <p class="text-purple-800 mb-2">At α = 0.05, df = 44:</p>
            <div class="bg-white p-4 rounded">
          ...
          <div class="bg-yellow-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-yellow-900 mb-3">Step 5: Draw Conclusion</h4>
            <p class="text-yellow-800">
    ...
    },
    {
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="space-y-4 my-6">
            <div class="bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
              <h4 class="font-bold text-red-900 mb-2">❌ "p-value is probability that H₀ is true"</h4>
              <p class="text-red-800 mb-3">Wrong! p-value is the probability of observing data as extreme as yours, assuming H₀ is true.</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
              <h4 class="font-bold text-yellow-900 mb-2">❌ "α = 0.05 is always the right significance level"</h4>
              <p class="text-yellow-800 mb-3">Wrong! The choice of α should depend on the context and consequences of errors.</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
              <h4 class="font-bold text-green-900 mb-2">❌ "Failing to reject H₀ means H₀ is true"</h4>
              <p class="text-green-800 mb-3">Wrong! It only means there's insufficient evidence to reject H₀.</p>
              <div class="bg-white p-3 rounded">
            ...
            <div class="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
              <h4 class="font-bold text-blue-900 mb-2">❌ "Small p-values mean large effects"</h4>
              <p class="text-blue-800 mb-3">Wrong! p-values depend on both effect size and sample size.</p>
              <div class="bg-white p-3 rounded">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 p-6 rounded-lg my-4">
            ...
            <div class="space-y-3">
              <div class="bg-white p-4 rounded-lg">
                <h5 class="font-bold text-teal-700 mb-2">1. Hypothesis Testing Framework</h5>
                <p class="text-gray-700 text-sm">A systematic process for making inferences about populations from sample data</p>
              </div>
              <div class="bg-white p-4 rounded-lg">
                <h5 class="font-bold text-blue-700 mb-2">2. Null vs. Alternative Hypotheses</h5>
                <p class="text-gray-700 text-sm">H₀ represents no effect; H₁ represents the effect of interest</p>
              </div>
              <div class="bg-white p-4 rounded-lg">
                <h5 class="font-bold text-green-700 mb-2">3. Types of Errors</h5>
                <p class="text-gray-700 text-sm">Type I (false positive) and Type II (false negative) errors with power considerations</p>
              </div>
              <div class="bg-white p-4 rounded-lg">
                <h5 class="font-bold text-purple-700 mb-2">4. Five-Step Process</h5>
                <p class="text-gray-700 text-sm">State question → Specify hypotheses → Choose test → Make decision → Draw conclusion</p>
              </div>
              <div class="bg-white p-4 rounded-lg">
                <h5 class="font-bold text-orange-700 mb-2">5. Real-World Application</h5>
                <p class="text-gray-700 text-sm">Applied hypothesis testing to engineering lubricant specifications</p>
              </div>
            </div>
          </div>

      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-teal-50 dark:bg-teal-900/20 border-l-4 border-teal-500 dark:border-teal-400 dark:border-teal-400 p-4 my-4">
            <p class="font-semibold text-teal-900 dark:text-teal-100 mb-2">💡 The Human Element</p>
          ...
          <div class="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border border-blue-200 dark:border-blue-800 my-6">
            ...
            <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
              <h5 class="font-bold text-blue-900 dark:text-blue-100 mb-2">🔬 Unit 1: Meaning and Roles of Science</h5>
              <p class="text-blue-800 dark:text-blue-200 text-sm">Exploring science's fundamental purpose and its transformative power</p>
            </div>
          </div>
        </div>
      `,
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 dark:text-white mb-4 text-xl">🧠 Science: A Multi-Faceted Endeavor</h4>
            <div class="space-y-4">
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-sm">
                <h5 class="font-bold text-blue-700 dark:text-blue-300 mb-2">📚 As Knowledge</h5>
                <p class="text-gray-700 dark:text-gray-300">A systematic body of testable explanations and predictions about the universe</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-sm">
                <h5 class="font-bold text-green-700 dark:text-green-300 mb-2">⚙️ As Methodology</h5>
                <p class="text-gray-700 dark:text-gray-300">A structured process of investigation and discovery</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-sm">
                <h5 class="font-bold text-purple-700 dark:text-purple-300 mb-2">🎯 As Purpose</h5>
                <p class="text-gray-700 dark:text-gray-300">Technology's foundation for improving human productivity and welfare</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 dark:text-white mb-3">Science encompasses investigation into:</h4>
          ...
          <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-400 dark:border-yellow-400 p-4 my-4">
            <p class="font-semibold text-yellow-900 dark:text-yellow-100 mb-2">💡 Evolutionary Knowledge</p>
          ...
          <div class="space-y-6 my-6">
            <div class="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border-l-4 border-blue-500 dark:border-blue-400 dark:border-blue-400">
              ...
              <div class="bg-white dark:bg-gray-700 p-3 rounded mt-3">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-300">Liberates humanity from superstition, myths, and unfounded fears</p>
              </div>
            </div>
            ...
            <div class="bg-green-50 dark:bg-green-900/20 p-5 rounded-lg border-l-4 border-green-500 dark:border-green-400 dark:border-green-400">
              ...
              <div class="bg-white dark:bg-gray-700 p-3 rounded mt-3">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-300">Facts obtained from data and tests become the foundation of truth</p>
              </div>
            </div>
            ...
            <div class="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-lg border-l-4 border-purple-500 dark:border-purple-400 dark:border-purple-400">
              ...
              <div class="bg-white dark:bg-gray-700 p-3 rounded mt-3">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-300">Discovery → Curiosity → Investigation → New Discovery</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg my-4">
            <h4 class="font-bold text-indigo-900 dark:text-indigo-100 mb-4">📋 The Scientific Method: 6-Step Process</h4>
            <div class="space-y-3">
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg flex items-start">
                <span class="text-indigo-600 mr-3 font-bold text-xl">1.</span>
                <div>
                  <strong class="text-gray-900 dark:text-white">Make an Observation</strong>
                  <p class="text-gray-700 dark:text-gray-300 text-sm mt-1">Notice something interesting in the natural world</p>
                </div>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg flex items-start">
                <span class="text-indigo-600 mr-3 font-bold text-xl">2.</span>
                <div>
                  <strong class="text-gray-900 dark:text-white">Ask a Question</strong>
                  <p class="text-gray-700 dark:text-gray-300 text-sm mt-1">Formulate a specific, testable question</p>
                </div>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg flex items-start">
                <span class="text-indigo-600 mr-3 font-bold text-xl">3.</span>
                <div>
                  <strong class="text-gray-900 dark:text-white">Form a Hypothesis</strong>
                  <p class="text-gray-700 dark:text-gray-300 text-sm mt-1">Propose a testable explanation</p>
                </div>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg flex items-start">
                <span class="text-indigo-600 mr-3 font-bold text-xl">4.</span>
                <div>
                  <strong class="text-gray-900 dark:text-white">Make Predictions</strong>
                  <p class="text-gray-700 dark:text-gray-300 text-sm mt-1">Determine expected outcomes if hypothesis is correct</p>
                </div>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg flex items-start">
                <span class="text-indigo-600 mr-3 font-bold text-xl">5.</span>
                <div>
                  <strong class="text-gray-900 dark:text-white">Test Predictions</strong>
                  <p class="text-gray-700 dark:text-gray-300 text-sm mt-1">Conduct experiments or gather data</p>
                </div>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg flex items-start">
                <span class="text-indigo-600 mr-3 font-bold text-xl">6.</span>
                <div>
                  <strong class="text-gray-900 dark:text-white">Iterate</strong>
                  <p class="text-gray-700 dark:text-gray-300 text-sm mt-1">Use results to refine hypotheses and continue investigation</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-6 my-6">
            <div class="bg-yellow-50 dark:bg-yellow-900/20 p-5 rounded-lg border-l-4 border-yellow-500 dark:border-yellow-400 dark:border-yellow-400">
              <h4 class="font-bold text-yellow-900 dark:text-yellow-100 mb-3">🏔️ Prehistoric Era</h4>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border-l-4 border-blue-500 dark:border-blue-400 dark:border-blue-400">
              <h4 class="font-bold text-blue-900 dark:text-blue-100 mb-3">🏛️ Ancient Egypt (c. 3000 BCE)</h4>
            ...
            <div class="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-lg border-l-4 border-purple-500 dark:border-purple-400 dark:border-purple-400">
              <h4 class="font-bold text-purple-900 dark:text-purple-100 mb-3">🇬🇷 Greco-Roman World</h4>
              <p class="text-purple-800 dark:text-purple-200 mb-3">
            ...
            <div class="bg-red-50 dark:bg-red-900/20 p-5 rounded-lg border-l-4 border-red-500 dark:border-red-400 dark:border-red-400">
              <h4 class="font-bold text-red-900 dark:text-red-100 mb-3">⚡ Scientific Revolution (17th Century)</h4>
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 dark:text-white mb-4 text-xl">🌍 Major Branches of Science</h4>
            <div class="grid md:grid-cols-3 gap-4">
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-green-200 dark:border-green-800">
                <h5 class="font-bold text-green-900 dark:text-green-100 mb-3">🔬 Natural Science</h5>
              ...
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                <h5 class="font-bold text-blue-900 dark:text-blue-100 mb-3">👥 Social Science</h5>
              ...
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
                <h5 class="font-bold text-purple-900 dark:text-purple-100 mb-3">🧠 Behavioral Science</h5>
          ...
          <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-400 dark:border-yellow-400 p-4 my-4">
            <p class="font-semibold text-yellow-900 dark:text-yellow-100 mb-2">📈 Expanding Frontiers</p>
            <p class="text-yellow-800 dark:text-yellow-200">
    ...
    },
    {
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg my-4">
            <h4 class="font-bold text-indigo-900 dark:text-indigo-100 mb-4">🔄 The Science-Technology Relationship</h4>
            <p class="text-indigo-800 dark:text-indigo-200 leading-relaxed mb-4">
          ...
          <div class="space-y-6 my-6">
            <div class="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border-l-4 border-blue-500 dark:border-blue-400 dark:border-blue-400">
              <h4 class="font-bold text-blue-900 dark:text-blue-100 mb-3">🏭 Industrial Revolution to Modern Era</h4>
              <p class="text-blue-800 dark:text-blue-200 mb-3">
            ...
            <div class="bg-green-50 dark:bg-green-900/20 p-5 rounded-lg border-l-4 border-green-500 dark:border-green-400 dark:border-green-400">
              <h4 class="font-bold text-green-900 dark:text-green-100 mb-3">🔬 Modern Technology Characteristics</h4>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-6 my-6">
            <div class="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg border-l-4 border-green-500 dark:border-green-400 dark:border-green-400">
              <h4 class="font-bold text-green-900 dark:text-green-100 mb-4">✨ Positive Impacts of Technology</h4>
              <div class="grid md:grid-cols-2 gap-4">
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-green-800 dark:text-green-200 mb-2">🥫 Food & Agriculture</h5>
                  <p class="text-green-700 dark:text-green-300 text-sm">Mechanized farming enables larger-scale cultivation, increased productivity, and better food security.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-green-800 dark:text-green-200 mb-2">🚗 Transportation</h5>
                  <p class="text-green-700 dark:text-green-300 text-sm">Modern vehicles and infrastructure dramatically reduce travel time and expand mobility.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-green-800 dark:text-green-200 mb-2">🏥 Healthcare</h5>
                  <p class="text-green-700 dark:text-green-300 text-sm">Scientific diagnosis and treatment have revolutionized medicine, extending lifespans and curing diseases.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-green-800 dark:text-green-200 mb-2">📡 Communication</h5>
                  <p class="text-green-700 dark:text-green-300 text-sm">Instant global connectivity through telephones, internet, and wireless technologies.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-green-800 dark:text-green-200 mb-2">⚡ Energy</h5>
                  <p class="text-green-700 dark:text-green-300 text-sm">Diverse energy sources power modern civilization and technological infrastructure.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-green-800 dark:text-green-200 mb-2">🏭 Manufacturing</h5>
                  <p class="text-green-700 dark:text-green-300 text-sm">High-tech production creates better products and industrial capabilities.</p>
                </div>
              </div>
            </div>

            <div class="bg-red-50 dark:bg-red-900/20 p-6 rounded-lg border-l-4 border-red-500 dark:border-red-400 dark:border-red-400">
              <h4 class="font-bold text-red-900 dark:text-red-100 mb-4">⚠️ Challenges and Side Effects</h4>
              <div class="space-y-4">
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-red-800 dark:text-red-200 mb-2">🔥 Environmental Impact</h5>
                  <p class="text-red-700 dark:text-red-300 text-sm">Industrial activities cause pollution, resource depletion, and habitat destruction.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-red-800 dark:text-red-200 mb-2">👥 Social Consequences</h5>
                  <p class="text-red-700 dark:text-red-300 text-sm">Job displacement, psychological stress, and intellectual redundancy affect workers.</p>
                </div>
                <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                  <h5 class="font-bold text-red-800 dark:text-red-200 mb-2">🏙️ Urbanization Effects</h5>
                  <p class="text-red-700 dark:text-red-300 text-sm">Fast-paced urban culture, commercialization, and loss of natural habitats.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-teal-50 dark:bg-teal-900/20 border-l-4 border-teal-500 dark:border-teal-400 dark:border-teal-400 p-4 my-4">
            <p class="font-semibold text-teal-900 dark:text-teal-100 mb-2">⚖️ Balanced Perspective</p>
            <p class="text-teal-800 dark:text-teal-200">
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg my-4">
            <h4 class="font-bold text-blue-900 dark:text-blue-100 mb-4">🎯 Essential Investments</h4>
            <div class="space-y-3">
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-blue-700 dark:text-blue-300 mb-2">📚 Quality Education</h5>
                <p class="text-gray-700 dark:text-gray-300">Strong foundation in STEM subjects for future innovators</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-blue-700 dark:text-blue-300 mb-2">🔧 Skills Training</h5>
                <p class="text-gray-700 dark:text-gray-300">Continuous professional development for workers and managers</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-blue-700 dark:text-blue-300 mb-2">💰 Strategic Funding</h5>
                <p class="text-gray-700 dark:text-gray-300">Government and private investment in research and development</p>
              </div>
            </div>
          </div>

          <div class="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-lg border border-purple-200 dark:border-purple-800 my-6">
            <h4 class="font-bold text-purple-900 dark:text-purple-100 mb-3">🚀 21st Century Technologies</h4>
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-purple-800 dark:text-purple-200 mb-2">🖥️ Microprocessors</h5>
              ...
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-purple-800 dark:text-purple-200 mb-2">📡 Telecommunications</h5>
                <ul class="text-sm text-purple-700 dark:text-purple-300 space-y-1">
              ...
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-purple-800 dark:text-purple-200 mb-2">🧬 Biotechnology</h5>
                <ul class="text-sm text-purple-700 dark:text-purple-300 space-y-1">
              ...
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-purple-800 dark:text-purple-200 mb-2">🤖 Emerging Technologies</h5>
                <ul class="text-sm text-purple-700 dark:text-purple-300 space-y-1">
      ...
      content: `
        <div class="space-y-4">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20 p-6 rounded-lg my-4">
            <h4 class="font-bold text-gray-900 dark:text-white mb-4 text-xl">🔑 Core Learnings</h4>
            <div class="space-y-3">
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-teal-700 dark:text-teal-300 mb-2">🧠 Science as Investigation</h5>
                <p class="text-gray-700 dark:text-gray-300 text-sm">Science is systematic investigation into environmental events, separating modern humans from primitive ancestors through knowledge and understanding.</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-blue-700 dark:text-blue-300 mb-2">🔬 Scientific Methodology</h5>
                <p class="text-gray-700 dark:text-gray-300 text-sm">The 6-step process (observation, question, hypothesis, prediction, testing, iteration) ensures reliable knowledge acquisition across all scientific disciplines.</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-green-700 dark:text-green-300 mb-2">⚡ Technology as Application</h5>
                <p class="text-gray-700 dark:text-gray-300 text-sm">21st century technologies including microprocessors, AI, and nanotechnology revolutionize productivity while presenting both opportunities and challenges.</p>
              </div>
              <div class="bg-white dark:bg-gray-700 p-4 rounded-lg">
                <h5 class="font-bold text-purple-700 dark:text-purple-300 mb-2">🌍 Development Imperative</h5>
                <p class="text-gray-700 dark:text-gray-300 text-sm">Science and technology are essential drivers for developing nations, requiring investment in education, skills training, and strategic research funding.</p>
              </div>
            </div>
          </div>

          <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-400 dark:border-yellow-400 p-4 my-4">
            <p class="font-semibold text-yellow-900 dark:text-yellow-100 mb-2">🎯 Moving Forward</p>
            <p class="text-yellow-800 dark:text-yellow-200">
          ...
          <div class="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg my-4">
            <h4 class="font-bold text-indigo-900 dark:text-indigo-100 mb-2">🤔 Self-Assessment Questions</h4>
            <div class="space-y-2 text-indigo-800 dark:text-indigo-200 text-sm">

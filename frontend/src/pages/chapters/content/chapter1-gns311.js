// Chapter 1: The Structure of Science, Scientific Methods and Revolution
// GNS 311 - Module 1

export const chapter1Content = {
  title: "The Structure of Science, Scientific Methods and Revolution",
  author: "Abimbola, I.O.",
  ...
  sections: [
      ...
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
            Welcome! 🌟 All disciplines have their structures, and science is no exception. 
          ...
          <p class="text-lg leading-relaxed">
            This chapter will take you through the history of scientific methods, introduce you to 
            the geniuses of the 17th century, and explore the early scientific societies that shaped 
            modern science.
          </p>
        </div>
      `,
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-3 list-none">
            <li class="flex items-start">
              ...
              <span>Define science and understand its components</span>
            </li>
            <li class="flex items-start">
              <span class="text-teal-500 mr-3 font-bold">✓</span>
              <span>Describe the structure, products, processes, and ethics of science</span>
            </li>
            <li class="flex items-start">
              <span class="text-teal-500 mr-3 font-bold">✓</span>
              <span>Discuss the functions and limitations of science</span>
            </li>
            <li class="flex items-start">
              <span class="text-teal-500 mr-3 font-bold">✓</span>
              <span>Explore the 17th century scientific revolution and its geniuses</span>
            </li>
            <li class="flex items-start">
              <span class="text-teal-500 mr-3 font-bold">✓</span>
              <span>Understand the role of scientific societies in advancing knowledge</span>
            </li>
            <li class="flex items-start">
              <span class="text-teal-500 mr-3 font-bold">✓</span>
              <span>Identify major scientific societies in Nigeria</span>
            </li>
          </ul>
        </div>
      `,
    ...
    {
      id: "unit1-intro",
      title: "📚 Unit 1: What is Science?",
      subtitle: "Concept of Science",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
            Let's start with the big question: <strong>What is science?</strong> 🤔
          </p>
          <p class="text-lg leading-relaxed">
    ...
    {
      id: "unit1-conceptions",
      title: "💡 Different Views of Science",
      subtitle: "General Conceptions About Science",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
          ...
          <div class="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg my-4">
            ...
            <ul class="space-y-2 text-indigo-800 dark:text-indigo-200">
              ...
              <li>⚖️ Governed by ethical principles</li>
    ...
    {
      id: "unit1-values",
      title: "💎 Why Understanding Science Matters",
      subtitle: "Values of the Structure of Science",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
    ...
    {
      id: "unit2-intro",
      title: "🏗️ Unit 2: The Building Blocks of Science",
      subtitle: "Components of the Structure of Science",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
    ...
    {
      id: "unit2-products",
      title: "📦 Science Products: The Knowledge We Gain",
      subtitle: "Science Products",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
            Science products are the <strong>knowledge outcomes</strong> of scientific work. They come 
            in different forms:
          </p>
    ...
    {
      id: "unit2-processes",
      title: "⚙️ Science Processes: How Scientists Work",
      subtitle: "Science Processes",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
          ...
          <p class="text-lg leading-relaxed">
            These processes are the <strong>scientific activity</strong> itself—they're what scientists 
            do every day!
          </p>
        </div>
      `,
    ...
    {
      id: "unit2-ethics",
      title: "⚖️ Science Ethics: The Scientist's Code",
      subtitle: "Science Ethics",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
    ...
    {
      id: "unit3-functions",
      title: "🎯 Unit 3: What Science Does",
      subtitle: "Functions of Science",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
    ...
    {
      id: "unit3-limitations",
      title: "⚠️ Science Has Limits Too",
      subtitle: "Limitations of Science",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
    ...
    {
      id: "unit4-intro",
      title: "⚡ Unit 4: The 17th Century Revolution",
      subtitle: "History of Scientific Methods and Revolution",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
          ...
          <p class="text-lg leading-relaxed">
            This was when scientists started paying attention to <strong>scientific methods</strong> 
            and revolutionized how we study nature!
          </p>
        </div>
      `,
      estimatedTime: 3
    ...
    {
      id: "unit4-methods",
      title: "🔬 The Birth of Scientific Methods",
      subtitle: "History of Scientific Methods",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
            Two great thinkers developed different approaches to scientific methods:
          </p>
    ...
    {
      id: "unit4-geniuses",
      title: "🌟 The Geniuses of the 17th Century",
      subtitle: "History and Achievements of Scientists",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
            The 17th century produced incredible scientists whose work still impacts us today!
          </p>
          ...
          <div class="space-y-4 my-6">
            <div class="bg-yellow-50 dark:bg-yellow-900/20 p-5 rounded-lg border-l-4 border-yellow-500 dark:border-yellow-400 dark:border-yellow-400">
              ...
              <ul class="space-y-2 text-yellow-800 dark:text-yellow-200">
                ...
                <li>✓ Discovered Jupiter has moons!</li>
                <li>✓ Proved the sun is the center of the solar system</li>
                <li>✓ Showed the Earth moves (not stationary!)</li>
              </ul>
            </div>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border-l-4 border-blue-500 dark:border-blue-400 dark:border-blue-400">
              ...
              <ul class="space-y-2 text-blue-800 dark:text-blue-200">
                ...
                <li>✓ Still used today for planning satellite orbits!</li>
              </ul>
            </div>
            ...
            <div class="bg-red-50 dark:bg-red-900/20 p-5 rounded-lg border-l-4 border-red-500 dark:border-red-400 dark:border-red-400">
              ...
              <ul class="space-y-2 text-red-800 dark:text-red-200">
                ...
                <li>✓ Regarded as the founder of physiology</li>
              </ul>
            </div>
            ...
            <div class="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-lg border-l-4 border-purple-500 dark:border-purple-400 dark:border-purple-400">
              ...
              <ul class="space-y-2 text-purple-800 dark:text-purple-200">
                ...
                <li>✓ Invented calculus!</li>
                <li>✓ Discovered light has color spectra</li>
                <li>✓ Invented reflecting telescope</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    {
      id: "unit4-societies",
      title: "🏛️ Scientific Societies: Where Scientists Meet",
      subtitle: "Organization and Roles of Scientific Societies",
      content: `
        <div class="space-y-4">
          <p class="text-lg leading-relaxed">
            Scientific societies were one of the most important developments of the 17th century! 
          ...
          <div class="space-y-4 my-6">
            <div class="bg-indigo-50 dark:bg-indigo-900/20 p-5 rounded-lg border-l-4 border-indigo-500 dark:border-indigo-400 dark:border-indigo-400">
              ...
              <ul class="space-y-2 text-indigo-800 dark:text-indigo-200">
                ...
                <li>✓ Coined the name "Microscope"</li>
              </ul>
            </div>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border-l-4 border-blue-500 dark:border-blue-400 dark:border-blue-400">
              ...
              <ul class="space-y-2 text-blue-800 dark:text-blue-200">
                ...
                <li>✓ Started publishing "Philosophical Transactions" in 1665</li>
                <li>✓ Forum for presenting papers and experiments</li>
              </ul>
            </div>
            ...
            <div class="bg-red-50 dark:bg-red-900/20 p-5 rounded-lg border-l-4 border-red-500 dark:border-red-400 dark:border-red-400">
              ...
              <ul class="space-y-2 text-red-800 dark:text-red-200">
                ...
                <li>✓ Inspected patents and designed machines</li>
              </ul>
            </div>

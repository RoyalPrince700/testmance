// Quiz data for GNS 311 Chapter 3: Concept of Matter
// Questions generated from the actual chapter content

export const gns311Chapter3Quiz = {
  title: 'GNS 311 Chapter 3: Concept of Matter',
  description: 'Test your understanding of matter, its states, kinetic theory, and nuclear changes based on Chapter 3 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Concept of Matter',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'According to the chapter, matter is defined as anything that occupies space and possesses:',
      options: [
        'Only mass',
        'Only inertia',
        'Mass and offers resistance to change of inertia',
    ...
    },
    {
      ...
      options: [
        ...
        'Vibrate and rotate about a mean position only',
        'Vibrate, rotate, and slide over each other easily',
    ...
    },
    {
      ...
      options: [
        ...
        'Particle velocity is large such that there are many collisions',
        'Particles have mutual attraction forces between them',
    ...
    },
    {
      ...
      options: [
        'Physical change involves state transformation, chemical change involves fundamental transformation',
        'Physical change is reversible, chemical change is not',
        'Physical change involves energy, chemical change does not',
    ...
    },
    {
      ...
      options: [
        'Splitting of a nucleus into two or more smaller nuclei',
        'Combining of two or more nuclei to form a heavier nucleus',
        'Emission of alpha and beta particles only',
        'Conversion of mass to energy without nuclear change'
      ],
      correctAnswer: 0,
    ...
    {
      question: 'According to the chapter, which of the following is NOT a property of living matter?',
      options: [
        'Respiration',
        'Growth',
        'Movement',
    ...
    },
    {
      ...
      options: [
        ...
        'Splitting a nucleus into smaller parts',
        'Emitting only gamma rays',
        'Converting matter to pure energy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Move randomly in all directions',
        'Vibrate and slide over each other',
        'Have no motion at all'
      ],
      correctAnswer: 2,
    ...
    {
      question: 'Which of the following is NOT one of the six fundamental assumptions of the kinetic theory?',
      options: [
        'Particle dimension is much less than collision distance',
        'Particles have mutual attraction forces',
    ...
    },
    {
      ...
      options: [
        ...
        'Physical changes involve state transformation only',
    ...
    },
    {
      ...
      options: [
        ...
        'Neutrons and protons repel',
        'Electrons and neutrons attract',
        'Two protons attract each other'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Direct solid to gas change without liquid phase',
        'Gas to solid change'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'They are stable and never decay',
        'They emit radiation that can be split by magnetic fields',
        'They only emit visible light',
        'They cannot undergo nuclear reactions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It allows all nations to develop nuclear weapons',
        'It aims to prevent the spread of nuclear weapons',
        'It was signed to promote nuclear energy only',
    ...
    },
    {
      ...
      options: [
        'Particles have large velocities',
    ...
    },
    {
      ...
      options: [
        'Electrons orbit in straight lines',
        'Protons orbit around electrons',
        'Electrons orbit the nucleus in spherical paths',
        'Neutrons orbit outside the atom'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Each reaction product initiates the next reaction',
    ...
    },
    {
      ...
      options: [
        ...
        'It is about 1,000,000 times more than chemical reactions',
        'It is the same as chemical reactions',
        'It produces no heat energy'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'According to the chapter, what is the precise definition of matter that includes all its essential properties?',
      options: [
        'Anything that has mass only',
        'Anything that occupies space and has mass',
        'Anything that occupies space, possesses mass of its own, offers resistance to change of inertia, and may be felt by sensory organs',
    ...
    },
    {
      ...
      options: [
        ...
        'Compounds have two or more different atoms chemically bonded',
        'Mixtures can be separated by physical means only',
        'Pure substances include both elements and mixtures'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Particle dimension is negligible compared to separation',
        'Particles move randomly with high velocity',
        'Collisions are perfectly elastic and instantaneous',
        'Particles have no mutual forces between them'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'It led to the concept of molecules as discrete entities',
        'It showed matter is infinitely divisible',
        'It had no impact on modern physics'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Solids have stronger chemical bonds',
        'Particle motion: solids vibrate in place, gases move randomly',
        'Solids have more particles than gases',
        'Temperature affects solids more than gases'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They explain why gases are invisible',
        'They collectively explain pressure, temperature, and volume relationships',
        'They only explain gas color',
        'They contradict experimental observations'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Forces don\'t exist in gases',
        'Forces are weak at large particle separations',
        'Forces only exist in solids',
        'Forces make calculations impossible'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Rutherford had electrons orbiting, Bohr had them in shells',
        'Rutherford showed nuclear structure, Bohr added quantized orbits',
        'Rutherford had circular orbits, Bohr had elliptical',
        'They were identical models'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It has no neutrons',
        'It has one proton and one electron in spherical orbit',
        'It has no protons',
        'It has multiple electrons'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It ensures charge balance and stability',
        'It affects neutron number',
    ...
    },
    {
      ...
      options: [
        'Δm = M_atom - (Z×M_proton + N×M_neutron)',
        'Δm = Z×M_proton + (A-Z)×M_neutron - M_atom',
        'Δm = M_proton + M_neutron - M_atom',
        'Δm = A × (M_proton + M_neutron)'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Nuclear bonds are stronger than chemical bonds',
        'Mass defect in nuclei is much larger than in molecules',
        'Nuclear reactions involve more particles',
        'Chemical reactions don\'t release energy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It creates a controlled energy release',
        'It causes an avalanche of reactions in a very short time',
    ...
    },
    {
      ...
      options: [
        'They were military bases only',
        'They were civilian cities with strategic significance',
        'They had no military value',
    ...
    },
    {
      ...
      options: [
        'Countries can ignore it completely',
        'It allows nations to choose participation while establishing norms',
        'It has no legal binding force',
        'Only superpowers must follow it'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Radiation has no long-term effects',
        'Effects are limited to immediate deaths',
        'Survivors suffer cancer, disabilities, and psychological trauma',
        'Radiation makes people immune to diseases'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Fission cannot produce electricity',
        'Heat from fission is converted to steam to turn turbines',
        'Fission produces electricity directly',
        'Electricity causes fission reactions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To show it\'s inefficient',
        'To explain the concentrated destructive power',
        'To demonstrate it\'s safe',
        'To show it\'s environmentally friendly'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They can block any resolution against them',
        'They control all UN decisions',
        'They have special authority over nuclear matters',
    ...
    },
    {
      ...
      options: [
        'The Act promoted nuclear weapons, the Treaty prevents them',
        'The Act controlled U.S. nuclear technology, the Treaty is international',
        'They are the same document',
        'The Treaty came before the Act'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Higher velocity means fewer collisions',
        'Higher velocity means more frequent collisions',
        'Velocity has no effect on collisions',
        'Low velocity means more collisions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It explains particle memory',
        'It allows statistical treatment of particle behavior',
        'It shows particles learn from collisions',
        'It proves particles are intelligent'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They make atoms unstable',
        'They accommodate more electrons in complex atoms',
        'They are simpler than circular orbits',
    ...
    },
    {
      ...
      options: [
        ...
        'Energy has mass but mass has no energy',
    ...
    },
    {
      ...
      options: [
        'It\'s the energy of chemical reactions',
        'It\'s approximately the binding energy per nucleon',
        'It\'s the energy of fusion only',
        'It has no significance'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The film shows positive uses of nuclear energy',
        'The film depicts the catastrophic consequences of nuclear war',
        'The film is about nuclear physics discoveries',
        'The film has no relation to the chapter'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Number of atoms × energy per fission × efficiency',
        'Simple multiplication of mass and energy',
    ...
    },
    {
      ...
      options: [
        'It changed nothing',
        'It provided a stronger international framework for nuclear treaties',
        'It eliminated nuclear weapons',
        'It weakened nuclear controls'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To show it\'s wasteful',
        'To explain how it can be converted to useful electricity',
        'To demonstrate it\'s dangerous',
        'To show it cannot be controlled'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Nuclear effects are localized only',
        'The energy release creates shockwaves, radiation, and fallout that extend far beyond ground zero',
        'Nuclear weapons have no long-range effects',
        'The effects are beneficial at long range'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Threat is the possibility, war is the actual occurrence',
        'War is impossible, threat is real',
        'Threat is military, war is civilian'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Nuclear pollution affects space only',
        'It shows the long-term environmental impact of nuclear technology',
        'Nuclear pollution is beneficial for space',
        'It has no environmental significance'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To show it failed',
        'To emphasize the treaty\'s goal of complete nuclear disarmament',
        'To prove nuclear weapons are useless',
        'To show treaties are ineffective'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Greeks believed matter was continuous, modern view sees it as discrete particles',
        'Greeks believed in atoms, modern science rejects this idea',
        'Greeks had no concept of matter, modern science invented it',
        'Both views are identical and unchanged'
      ],
      correctAnswer: 0,

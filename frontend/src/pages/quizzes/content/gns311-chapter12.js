// Quiz data for GNS 311 Chapter 12: Achieving Knowledge Management Functionalities in the Emerging Technology-Driven Society Using Information Technology
// Questions generated from the actual chapter content

export const gns311Chapter12Quiz = {
  title: 'GNS 311 Chapter 12: Achieving Knowledge Management Functionalities in the Emerging Technology-Driven Society Using Information Technology',
  description: 'Test your understanding of knowledge management tools, functionalities, and IT integration in the technology-driven society',
  courseCode: 'GNS 311',
  chapterTitle: 'Achieving Knowledge Management Functionalities in the Emerging Technology-Driven Society Using Information Technology',
  passingScore: 70,
  timeLimit: 75, // minutes
  questions: [
    {
      question: 'What is the primary definition of Knowledge Management (KM) according to the chapter?',
      options: [
        'The study of computer systems',
        'Strategies and applications for creating, documenting, and sharing knowledge',
    ...
    },
    {
      ...
      options: [
        'Intranet uses TCP/IP, extranet does not',
        'Intranet is internal only, extranet extends to external partners',
        'Intranet has security, extranet does not',
        'Intranet is web-based, extranet is not'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The second version of knowledge management software',
        'The mapping of Web 2.0 principles to knowledge management',
    ...
    },
    {
      ...
      options: [
        'To store old computers',
        'To provide managers with quality information for decision-making',
        'To create physical warehouses for data storage',
    ...
    },
    {
      ...
      options: [
        'To create documents',
        'To establish the flow of information among knowledge workers',
        'To store data',
    ...
    },
    {
      ...
      options: [
        'Extensible Markup Language - creates metadata for information classification',
        'Extra Modern Language - modernizes old documents',
        'Xtreme Management Language - manages extreme data',
        'Xml Markup Language - marks up XML documents'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'They are cheaper than dial-up',
        'They can transport multiple signals and traffic types simultaneously',
        'They work without electricity',
        'They only transmit text data'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Data mining drives data warehousing',
        'Data warehousing drives data mining',
    ...
    },
    {
      ...
      options: [
        ...
        'To classify content so it can be searched and retrieved',
    ...
    },
    {
      ...
      options: [
        ...
        'It creates metadata and enables semantic content sorting',
        'It encrypts documents',
        'It converts documents to images'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Directory searches',
        'Special search engines like Ask Jeeves',
        'Meta search engines',
        'Open directory searches'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To protect internal resources from external access',
        'To compress data',
    ...
    },
    {
      ...
      options: [
        'They are free',
        'They offer a common look and feel across applications',
        'They work without electricity',
    ...
    },
    {
      ...
      options: [
        ...
        'They allow access to content despite format obsolescence',
        'They encrypt data',
        'They speed up computers'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'OLAP works with data warehouses and employs data mining techniques',
        'Data mining replaces OLAP',
        'They are unrelated'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To handle creation, management, and distribution of content',
    ...
    },
    {
      ...
      options: [
        'It eliminates all paper usage',
        'It originates from workflow concepts replacing manual document exchange',
        'It means no printers are needed',
        'It refers to digital-only companies'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Decreasing professional specialization'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'To track changes and allow access to previous versions',
    ...
    },
    {
      ...
      options: [
        ...
        'To identify text on scanned images for indexing',
        'To delete documents',
        'To print documents'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To store data',
        'To search stored data for patterns that lead to new insights',
        'To delete old data',
        'To create backups'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Publishing, searching, transacting, interacting, and recording',
    ...
    },
    {
      ...
      options: [
        'It enables video streaming only',
        'It allows creation of internal networks with common Internet applications',
        'It provides security only',
        'It manages employee data only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To verify user identity and limit access',
        'To compress data',
    ...
    },
    {
      ...
      options: [
        ...
        'Avalanche of information and decision-making demands',
        'Reduced competition',
    ...
    },
    {
      ...
      options: [
        'Lower operational costs only',
        'Systematic leverage of information and expertise for better responsiveness',
    ...
    },
    {
      ...
      options: [
        'To store data',
        'To manipulate and analyze data for decision support',
        'To mine data for patterns',
        'To create backups'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Replaces tiring and time-consuming manual document exchange',

// Quiz data for GNS 311 Chapter 15: Microbes and Diseases
// Questions generated from the actual chapter content

export const gns311Chapter15Quiz = {
  title: 'GNS 311 Chapter 15: Microbes and Diseases',
  description: 'Test your understanding of microorganisms, host invasion, pathogenicity, reservoirs, transmission, and microbial diseases based on Chapter 15 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Microbes and Diseases',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'What is the term for organisms that cannot be seen with the naked eye and combine plant and animal features?',
      options: [
        'Protozoa',
        'Microorganisms',
        'Bacteria',
    ...
    },
    {
      ...
      options: [
        ...
        'The ability of microbes to reproduce',
        'The ability of microbes to survive in reservoirs',
        'The ability of microbes to transmit between hosts'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'A pathogen that utilizes contact to get across to a new host',
        'A disease spread through the air',
        'A disease spread by vectors'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Viruses are resistant to all antibiotics',
        'Viruses reside within host cells where drugs cannot reach them',
        'Viruses multiply too quickly',
        'Viruses have no specific target sites'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Athlete\'s foot',
        'Ringworm',
        'Both ringworm and athlete\'s foot',
        'Neither'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Through personal or indirect contact',
    ...
    },
    {
      ...
      options: [
        'Fever and joint pains only',
        'Headache, fever, joint pains, and dark urine',
    ...
    },
    {
      ...
      options: [
        'Fever, emaciation, and excessive sleepiness',
    ...
    },
    {
      ...
      options: [
        'Loss of sensation and skin sores',
        'Severe diarrhea',
        'High fever',
        'Joint pain'
      ],
    ...
    },
    {
      ...
      options: [
        ...
        'Scientific revolution and modern methods',
    ...
    },
    {
      ...
      options: [
        'Blood loss through diarrhea',
        'Destruction of red blood cells by parasites',
        'Nutrient deprivation',
    ...
    },
    {
      ...
      options: [
        ...
        'Department of Biological Sciences, University of Ibadan',
        'Department of Medical Microbiology, University of Benin'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Transmission and microbial diseases',
    ...
    },
    {
      ...
      options: [
        'Painful urination',
        'Skin blisters and brain damage',
        'Severe diarrhea',
        'Chest pain and coughing'
      ],
      correctAnswer: 1,

// Quiz data for GNS 311 Chapter 11: Human Nutrition: A Life Course Approach
// Questions generated from the actual chapter content

export const gns311Chapter11Quiz = {
  title: 'GNS 311 Chapter 11: Human Nutrition: A Life Course Approach',
  description: 'Test your understanding of human nutrition across the life course, including nutrients, malnutrition, vulnerable groups, and obesity management',
  courseCode: 'GNS 311',
  chapterTitle: 'Human Nutrition: A Life Course Approach',
  passingScore: 70,
  timeLimit: 75, // minutes
  questions: [
    {
      question: 'What is the primary definition of nutrition according to the chapter?',
      options: [
        'The study of food production',
        'The science of food-nutrient interactions and health',
        'The analysis of food prices',
        'The measurement of food quantities'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Contains anti-infective properties',
    ...
    },
    {
      ...
      options: [
        ...
        'The highest intake likely to pose no risk',
        'The average daily requirement',
        'The nutrient storage capacity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'When RDA is not established',
        'When nutrients are toxic',
    ...
    },
    {
      ...
      options: [
        'Iron deficiency - immediate blood transfusion',
        'Vitamin B12 deficiency - intramuscular injections',
        'Folic acid deficiency - high-dose oral supplements',
        'Vitamin C deficiency - citrus fruit supplementation'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Daily multivitamin supplementation only',
        'High-protein diet (1.6g/kg body weight) combined with resistance training',
        'Increased calcium intake to prevent osteoporosis',
        'Frequent small meals to improve appetite'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        '2100 kcal/day (500 kcal deficit)',
        '2450 kcal/day (350 kcal deficit)',
        '2600 kcal/day (200 kcal deficit)',
        '2950 kcal/day (150 kcal deficit)'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Marasmic-kwashiorkor (mixed malnutrition)',
    ...
    },
    {
      ...
      options: [
        'Dietary recall of vitamin A-rich foods',
        'Serum retinol concentration',
        'Liver vitamin A reserves',
        'Dark adaptation test results'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        '285 kcal/day (850mL × 0.34 kcal/mL)',
        '550 kcal/day (850mL × 0.65 kcal/mL)',
        '680 kcal/day (850mL × 0.8 kcal/mL)',
        '920 kcal/day (850mL × 1.08 kcal/mL)'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Western pattern: high red meat, processed foods, refined grains',
        'Mediterranean pattern: fruits, vegetables, whole grains, olive oil, fish',
        'High-protein pattern: meat, eggs, dairy, low carbohydrates',
        'Vegetarian pattern: plant-based foods, legumes, minimal animal products'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Marasmus - gradual nutritional rehabilitation',
        'Kwashiorkor - cautious refeeding with micronutrient supplementation',
        'Iron deficiency anemia - iron supplementation',
        'Vitamin A deficiency - high-dose vitamin A therapy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'All carbohydrates equally affect glucose levels'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Decreased vitamin D synthesis in skin',
        'Enhanced parathyroid hormone secretion',
        'Improved kidney function for calcium reabsorption'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        '35g/day (0.5g/kg to reduce kidney burden)',
        '56g/day (0.8g/kg standard RDA)',
        '70g/day (1.0g/kg for muscle maintenance)',
        '84g/day (1.2g/kg for recovery from illness)'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        '45% carbohydrates, 30% protein, 25% fat',
        '70% carbohydrates, 20% protein, 10% fat',
    ...
    },
    {
      ...
      options: [
        ...
        'Increased maternal cortisol secretion'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Increased calcium intake to 1200mg/day',
        'Reduced sodium intake to <2300mg/day',
        'DASH diet (high fruits/vegetables, low saturated fat)',
        'Mediterranean diet with olive oil emphasis'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        '0.5 kcal/mL (standard infant formula)',
        '0.8 kcal/mL (F-75 therapeutic milk)',
        '1.0 kcal/mL (standard adult nutrition)',
        '1.5 kcal/mL (high-energy supplements)'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        '200mg calcium supplement',
        '400mg calcium supplement',
        '600mg calcium supplement',
        '800mg calcium supplement'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Mandatory BMI screening for all students',
        'Elimination of competitive foods and sugary drinks',
        'Increased physical education from 30 to 60 minutes daily',
        'Parental education on healthy home meals only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Individual dietary counseling for each woman',
        'Fortification of staple foods with multiple micronutrients',
        'Distribution of pharmaceutical vitamin supplements',
        'Promotion of expensive animal-source foods'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Increased breast milk volume production',
        'Preferential allocation of available nutrients to milk',
        'Reduced caloric density of breast milk',
    ...
    },
    {
      ...
      options: [
        'Increased salt intake to stimulate thirst',
        'Scheduled fluid intake reminders and accessible water',
        'Diuretic medication to increase urine output',
        'High-protein diet to increase metabolic water'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Add 10mL/kg for each diarrheal stool',
        'Add 20mL/kg for each diarrheal stool',
        'Add 50mL/kg for each diarrheal stool',
        'Double maintenance fluids automatically'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Folic acid intake of at least 400μg/day',
    ...
    },
    {
      ...
      options: [
        '0.6 kcal/mL with 3% protein for stabilization',
        '0.8 kcal/mL with 3% protein for stabilization',
        '0.8 kcal/mL with 5% protein for catch-up growth',
        '1.0 kcal/mL with 5% protein for catch-up growth'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        '15μg/day (600 IU) as standard RDA',
        '25μg/day (1000 IU) for moderate deficiency',
        '50μg/day (2000 IU) for severe deficiency',
        '100μg/day (4000 IU) for treatment'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Hb < 10.0 g/dL (consistent with non-pregnant)',
        'Hb < 11.0 g/dL (WHO standard for pregnant women)',
        'Hb < 9.0 g/dL (severe anemia threshold)',
        'Hb < 7.0 g/dL (life-threatening anemia)'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Liberalized diet to prevent further weight loss',
        'Standard hypocaloric diet with exercise',
        'Protein restriction to reduce kidney burden'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Additional 0.2g/kg for minor wounds',
        'Additional 0.5g/kg for major surgery',
        'Additional 1.0g/kg for severe trauma',
        'No additional protein needed'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Clinical eye examination for Bitot spots',
        'Household food frequency questionnaire'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Increase to 35mL/kg/day for better cardiac output',
        'Maintain 30mL/kg/day as standard',
        'Restrict to 20mL/kg/day to reduce preload',
        'Restrict to 15mL/kg/day for severe cases'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Mediterranean diet with moderate alcohol'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Simple random sampling calculation',

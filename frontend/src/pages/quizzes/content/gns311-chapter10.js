// Quiz data for GNS 311 Chapter 10: Fundamentals of Poultry Production
// Questions generated from the actual chapter content

export const gns311Chapter10Quiz = {
  title: 'GNS 311 Chapter 10: Fundamentals of Poultry Production',
  description: 'Test your understanding of poultry species, management systems, production cycles, nutrition, and health management based on Chapter 10 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Fundamentals of Poultry Production',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'What is the most common poultry species worldwide according to the chapter?',
      options: [
        'Turkey',
        'Duck',
        'Chicken',
    ...
    {
      question: 'Which nutrient provides the highest energy density in poultry feed?',
      options: [
        'Carbohydrates',
        'Protein',
        'Fat',
    ...
    {
      question: 'What humidity level is required for optimal egg incubation?',
      options: [
        '30-40%',
        '40-50%',
        '50-60%',
    ...
    {
      question: 'Why is wood shavings commonly used in deep litter systems in Nigeria?',
      options: [
        'They are expensive',
        'They are readily available',
        'They provide better insulation',
        'They reduce disease transmission'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'For better sleep',
        'For sexual maturity initiation',
    ...
    },
    {
      ...
      options: [
        ...
        'To prevent cannibalism and feather pecking',
        'To reduce noise',
    ...
    },
    {
      ...
      options: [
        ...
        'To prevent floor eggs and facilitate collection',
    ...
    },
    {
      ...
      options: [
        'For calculating egg production',
        'For feed formulation and balancing nutrients',
    ...
    },
    {
      ...
      options: [
        ...
        'Larger scale production capacity',
        'Lower costs',
    ...
    },
    {
      ...
      options: [
        'It\'s more effective orally',
        'It provides early protection',
        'It\'s cheaper',
    ...
    },
    {
      ...
      options: [
        ...
        'Feed costs account for 55-75% of expenses',
        'Feed costs are 25-35% of expenses',
        'Feed costs are 80-90% of expenses'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To reduce feed costs',
        'To prevent disease introduction and spread',
    ...
    },
    {
      ...
      options: [
        'To prevent vaccine reactions',
        'To boost immune response',
        'To reduce stress from handling',
    ...
    },
    {
      ...
      options: [
        'Only for drinking',
        'For all body functions including digestion and temperature regulation',
        'Only during hot weather',
        'Only for egg production'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'If a poultry farmer in Nigeria wants to minimize costs while ensuring disease resistance, which management system should they choose?',
      options: [
        'Battery cage system',
        'Deep litter system',
        'Free range system',
    ...
    },
    {
      ...
      options: [
        ...
        'Utilize natural tropical sunlight',
        'Minimal lighting'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'For meat quality',
        'For eggshell strength and production',
        'For feather growth',
    ...
    },
    {
      ...
      options: [
        'Faster hatching',
        'Embryo death due to lack of oxygen',
        'Better chick quality',
        'Higher hatchability'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Better nutrition',
        'Contact with wild birds and environment',
        'Warmer temperatures',
        'Higher humidity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Housing color',
        'Consistent nutrition and health care',
        'Bird breed selection',
    ...
    },
    {
      ...
      options: [
        ...
        'To prevent disease spread to healthy birds',
        'To reduce feed costs',
    ...
    },
    {
      ...
      options: [
        'Better ventilation in deep litter',
        'Higher bird density and litter contamination',
        'Lower humidity in deep litter',
        'Colder temperatures'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Increase protein in feed',
        'Debeaking and proper stocking density',
        'Reduce lighting',
    ...
    },
    {
      ...
      options: [
        'For hydration only',
        'Water serves as the medium for feed medication and temperature regulation',
        'Only during vaccination',
        'Only for adult birds'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Higher cost',
        'Better absorbency and local availability',
    ...
    },
    {
      ...
      options: [
        'To count them',
        'To assess temperature comfort and health',
        'To measure feed intake',
        'To check feather growth'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Higher protein always means faster growth',
        'Optimal protein levels (18-23%) maximize growth efficiency',
        'Protein level has no effect on growth',
        'Lower protein is better for broilers'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Viral infections show different symptoms',
        'Both A and B',
    ...
    },
    {
      ...
      options: [
        'Reduce protein content drastically',
        'Use local feed ingredients and proper formulation',
        'Eliminate vitamin supplements',
    ...
    },
    {
      ...
      options: [
        'It\'s more expensive',
        'It provides early immunity before exposure',
        'It\'s easier to administer',
        'It lasts longer'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Kidney damage and reduced egg production',
        'Improved growth',
        'Disease resistance'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To increase vaccine cost',
        'To reduce stress and improve immune response',
    ...
    },
    {
      ...
      options: [
        ...
        'To monitor performance and make management decisions',
        'To count birds',
    ...
    },
    {
      ...
      options: [
        'Vaccination only',
        'Coccidiostats in feed and clean litter management',
        'Antibiotics',
    ...
    },
    {
      ...
      options: [
        ...
        'Lower cost and traditional knowledge availability',
    ...
    },
    {
      ...
      options: [
        'Heat stress',
        'Poor growth and increased disease susceptibility',
        'Excessive eating',
    ...
    },
    {
      ...
      options: [
        'For better taste',
        'To meet additional calcium needs during egg production',
        'For mineral balance',
    ...
    },
    {
      ...
      options: [
        'Lower cost',
        'Easier egg collection and manure removal',
        'Better ventilation',
        'More space per bird'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Deep litter system',
        'Free range system',
        'Intensive confinement with automation'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'For egg production',
        'For rapid muscle growth and development',
        'For disease resistance',
        'For feather quality'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Poor feed quality',
        'Visitor and vehicle traffic introducing diseases',
        'Weather conditions',
        'Equipment failure'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To prevent vent pecking during egg production',
    ...
    },
    {
      ...
      options: [
        'Feed color',
        'Disease presence and nutrition adequacy',
        'Housing color',
        'Bird age'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Better chick quality',
        'Year-round supply and genetic uniformity',
        'Lower costs',
        'Traditional methods'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'No relationship',
        'Higher density increases disease transmission risk',
        'Lower density increases disease risk',
        'Density affects only growth'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They are essential amino acids that must be provided in feed',
    ...
    },
    {
      ...
      options: [
        ...
        'Administer coccidiostats and improve sanitation',
        'Change water source',

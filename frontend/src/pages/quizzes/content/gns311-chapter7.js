// Quiz data for GNS 311 Chapter 7: Atmospheric Environment, Air Pollution and Public Health
// Questions generated from the actual chapter content

export const gns311Chapter7Quiz = {
  title: 'GNS 311 Chapter 7: Atmospheric Environment, Air Pollution and Public Health',
  description: 'Test your understanding of atmospheric layers, air pollution, and their impacts on public health based on Chapter 7 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Atmospheric Environment, Air Pollution and Public Health',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'What is the primary function of the ozone layer in the stratosphere?',
      options: [
        'To create weather patterns',
        'To absorb harmful UV radiation',
        'To regulate temperature directly',
    ...
    },
    {
      ...
      options: [
        ...
        'Air, water, land, plants',
        'Gases, solids, liquids, organisms',
    ...
    },
    {
      ...
      options: [
        ...
        'Primary pollutants enter the atmosphere directly, secondary form through chemical reactions',
        'Primary pollutants are gases, secondary are particulates',
        'Primary pollutants are visible, secondary are invisible'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Chemical (organic vs inorganic)',
        'Physical state (gaseous vs particulate)',
        'Origin (natural vs anthropogenic)',
        'Color (visible vs invisible)'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Cold temperatures',
        'Sunlight triggering chemical reactions',
        'High humidity',
        'Strong winds'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        '800,000 annual deaths worldwide',
        '500,000 annual deaths worldwide',
        '1 million annual deaths worldwide',
        '200,000 annual deaths worldwide'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Maintaining temperature through greenhouse effect',
        'Producing rain',
        'Creating lightning'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Why does temperature decrease with altitude in the troposphere?',
      options: [
        'Due to less air pressure',
        'Because warm air rises and cools as it expands',
        'Due to the absence of ozone',
        'Because of colder air from space'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They regulate Earth\'s temperature through the greenhouse effect',
        'They create weather patterns',
        'They filter UV radiation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Natural sources are always less harmful',
        'Anthropogenic sources are human-caused activities',
        'Natural sources only occur at night',
        'Anthropogenic sources are only gaseous'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Because people drive more during lunch hour',
        'Due to maximum sunlight intensity triggering reactions',
        'Because temperatures are highest then',
    ...
    },
    {
      ...
      options: [
        'NO increases steadily',
        'NO decreases while NO₂ and oxidants increase',
        'NO stays constant',
        'NO becomes the dominant pollutant'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It releases greenhouse gases and particulates in high amounts',
        'It has no health effects',
        'It only occurs during winter'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'People spend little time indoors',
        'Concentrations can be 100-1000 times higher than outdoors',
        'Indoor air is always cleaner',
        'There are no sources of indoor pollution'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'VOCs prevent smog formation',
        'VOCs are key reactants in photochemical smog formation',
        'VOCs have no role in smog',
        'VOCs only form after smog'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It shows air pollution is a leading cause of death worldwide',
    ...
    },
    {
      ...
      options: [
        ...
        'Poor ventilation and concentrated sources',
        'Outdoor pollution enters freely',
    ...
    },
    {
      ...
      options: [
        ...
        'They can cause cancer and organ damage',
        'They improve respiratory function',
    ...
    },
    {
      ...
      options: [
        'It has no role in climate',
        'It maintains temperature through greenhouse gases',
    ...
    },
    {
      ...
      options: [
        'It contains most weather',
        'It has the ozone layer that protects from UV radiation',
    ...
    {
      question: 'How does the temperature profile of the mesosphere contribute to its role in atmospheric protection?',
      options: [
        'Cold temperatures prevent chemical reactions',
        'Cold temperatures cause meteors to burn up before reaching Earth',
        'Cold temperatures create ozone',
    ...
    },
    {
      ...
      options: [
        'Major gases don\'t absorb infrared radiation',
        'Trace gases are more abundant',
        'Major gases block sunlight completely',
        'Trace gases are not needed for the greenhouse effect'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'It shows all pollution is natural',
        'It helps identify controllable human sources',
        'It proves pollution can\'t be controlled',
        'It focuses only on natural solutions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It changes chemical composition at different altitudes',
        'Stratospheric ozone blocks UV, tropospheric ozone is a pollutant',
    ...
    },
    {
      ...
      options: [
        'It shows chemistry only happens at night',
        'It demonstrates sunlight as an energy source for reactions',
        'It proves reactions don\'t need catalysts',
        'It shows temperature drives all reactions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They can cause permanent cognitive impairment and Alzheimer\'s',
    ...
    },
    {
      ...
      options: [
        'It shows humans have no impact',
        'It demonstrates how land use practices create climate forcing',
        'It proves burning is beneficial',
        'It shows natural fires are worse'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Outdoor VOCs are more toxic',
        'Prolonged exposure in confined spaces increases total dose',
        'Indoor VOCs are less toxic',
        'Ventilation eliminates the risk'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Low boiling point means they don\'t evaporate',
        'Low boiling point means they readily become airborne and inhalable',
        'High boiling point VOCs are more dangerous',
        'Boiling point has no relation to health impacts'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It proves air pollution is not a problem',
        'It quantifies the human cost of atmospheric pollution',
        'It shows deaths are decreasing',
        'It only counts outdoor deaths'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Children have stronger lungs',
        'Children have higher metabolic rates and breathe more air per body weight',
        'Children are immune to particulates',
        'Children don\'t inhale particulates'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It makes mitigation easier',
        'It requires addressing cultural and economic factors',
        'It proves climate change is natural',
        'It eliminates the need for action'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It concentrates lifetime exposure in potentially polluted environments',
    ...
    },
    {
      ...
      options: [
        'Modern buildings have perfect ventilation',
        'Building materials and products release VOCs continuously',
        'VOCs only come from outdoors',
        'Modern homes have no VOC sources'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It prevents smog formation',
        'Warm air above cool air traps pollutants near the surface',
        'It causes pollutants to rise',
        'It eliminates temperature differences'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It consumes all available oxygen',
        'One reaction initiates many subsequent reactions',
    ...
    },
    {
      ...
      options: [
        'Larger particles are more dangerous',
        'Smaller particles penetrate deeper into the lungs',
        'Size has no effect on health',
        'All particles are filtered out'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The body becomes immune over time',
        'Accumulated exposure causes cellular and systemic damage',
        'Symptoms disappear over time',
        'Long-term exposure is beneficial'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It dilutes pollutants but doesn\'t react with them',
        'It reacts with all pollutants',
    ...
    },
    {
      ...
      options: [
        'It affects surface temperature',
        'It demonstrates how UV radiation can heat atmospheric gases',
        'It cools the Earth',
    ...
    },
    {
      ...
      options: [
        'Pollution stays in one sphere',
        'Pollution can move between spheres through various pathways',
        'Spheres are completely separate',
        'Only air pollution moves'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Each provides different components for the reaction chain',
        'Only NOx is needed',
        'Only VOCs are needed'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Insufficient oxygen leads to CO instead of CO₂',
        'CO forms from complete combustion',
        'Oxygen has no role in combustion'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They can cause birth defects and infertility across generations',
    ...
    },
    {
      ...
      options: [
        'Dense air burns meteors',
        'Atmospheric density provides friction for ablation',
        'Meteors burn due to heat',
        'Density has no role'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It only affects climate',
        'It emits both greenhouse gases and particulates simultaneously',
    ...
    },
    {
      ...
      options: [
        'It reduces risks',
        'It increases exposure concentration in living spaces',
        'It eliminates VOCs',
        'It only affects outdoors'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s too low for protection',
        'It\'s high enough to absorb UV but low enough for concentration',
        'It\'s too high to be effective',
    ...
    },
    {
      ...
      options: [
        'It prevents reactions',
        'It converts light energy into chemical energy',
        'It blocks all light',
        'It has no photochemical role'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Different sizes penetrate different parts of the respiratory system',
        'Size doesn\'t matter for health',
        'Only PM₁₀ is harmful'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Long lifetime means less impact',
        'Short-lived pollutants cause local effects, long-lived cause global effects',
        'Lifetime has no effect',
        'All pollutants have the same lifetime'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s not essential',
        'It maintains Earth\'s habitable temperature without it Earth would be frozen',

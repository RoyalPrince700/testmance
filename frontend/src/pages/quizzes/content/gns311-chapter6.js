// Quiz data for GNS 311 Chapter 6: Medicinal Plants: Myths, Facts, Conservation and Tissue Culture Techniques
// Questions generated from the actual chapter content

export const gns311Chapter6Quiz = {
  title: 'GNS 311 Chapter 6: Medicinal Plants: Myths, Facts, Conservation and Tissue Culture Techniques',
  description: 'Test your understanding of medicinal plants, traditional medicine, conservation strategies, and modern tissue culture techniques based on Chapter 6 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Medicinal Plants: Myths, Facts, Conservation and Tissue Culture Techniques',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'According to WHO, what percentage of the world\'s population relies on herbal medicines as their primary healthcare?',
      options: [
        '40%',
        '60%',
        '80%',
    ...
    },
    {
      ...
      options: [
        'Traditional medicine uses only plants, herbal medicine uses chemicals',
        'Traditional medicine includes spiritual therapies and manual techniques, herbal medicine focuses specifically on herbs',
        'Traditional medicine is modern, herbal medicine is ancient',
    ...
    },
    {
      ...
      options: [
        'Its taste and effectiveness against diabetes',
        'Its use as a laxative only',
        'Its role in hypertension treatment',
        'Its effectiveness against malaria'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'They are more expensive than conventional drugs',
        'They cause more side effects than modern medicines',
        'Rising costs of imported medicines make herbal alternatives more attractive',
        'They are less effective than conventional treatments'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Cost effectiveness',
        'Widely available',
        'Always more effective than conventional drugs'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Herbs always come in standardized doses',
        'No standardized dosage instructions',
        'Herbs are always taken in the same amounts',
        'Dosage is always clearly marked on packages'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Myth 1: Herbs Are Always Safe',
        'Myth 2: Herbs Lack Scientific Evidence',
        'Myth 3: Multi-Herb Mixtures Are Better',
        'Myth 4: Herbs Can\'t Be Standardized'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Herbs work against each other',
        'Herbs work together for comprehensive healing',
        'Herbs only work when taken alone',
        'Herbs cancel each other\'s effects'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Long-term storage at ultra-low temperatures (-196°C)',
        'Seed propagation in fields',
        'Plant tissue culture in labs'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Why might a patient prefer consulting a herbalist over a conventional doctor, according to the chapter?',
      options: [
        'Herbalists charge more money',
        'Herbalists build personal relationships and provide more open communication',
        'Herbalists only treat acute illnesses',
        'Herbalists use more expensive treatments'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'All herbs are poisonous',
        'Wild herbs can be toxic if misidentified',
        'Cultivated herbs are always safe',
        'Only imported herbs are dangerous'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'By stating all traditional medicine is folklore',
        'By showing that many modern drugs originate from plants and 74% of pharmaceutical medicines have herbal origins',
        'By claiming herbs are better than all conventional drugs',
        'By saying scientific research is unnecessary'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Standardization should be avoided as it reduces effectiveness',
        'Standardization should be mandatory to ensure safety and efficacy',
        'Standardization is impossible for herbs',
        'Standardization is only needed for expensive herbs'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It only works for common plants',
        'It allows rapid multiplication of rare and recalcitrant species',
        'It requires large amounts of plant material',
        'It only produces diseased plants'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'In-situ is more expensive than ex-situ',
        'In-situ protects plants in natural habitats, ex-situ protects them outside natural habitats',
        'Ex-situ is only for aquatic plants',
        'In-situ only uses tissue culture'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They maintain diverse plant collections, develop propagation protocols, and support domestication programs',
        'They only grow decorative plants',
        'They focus only on rare plants'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It only works in winter',
        'It allows production independent of seasonal constraints',
        'It requires specific weather conditions',
    ...
    },
    {
      ...
      options: [
        'Regulation makes herbs more expensive',
        'Quality and safety are not guaranteed without regulation',
        'Regulation prevents traditional use',
        'Regulation eliminates all benefits'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'If a pharmaceutical company wants to develop a standardized herbal medicine from bitter leaf, which myth from the chapter would they most need to address?',
      options: [
        'Myth 1: Herbs Are Always Safe',
        'Myth 2: Herbs Lack Scientific Evidence',
        'Myth 3: Multi-Herb Mixtures Are Better',
    ...
    },
    {
      ...
      options: [
        'The plant\'s habitat is completely destroyed',
        'The plant grows well in natural reserves',
        'The plant has many natural predators',
        'The plant prefers natural soil conditions'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'It would eliminate all traditional practices',
        'It could provide disease-free, standardized herbs while preserving traditional knowledge',
        'It would make herbs too expensive for local use',
        'It would replace all traditional practitioners'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Immediately stop conventional drugs and use only herbs',
        'Consult a qualified practitioner who can integrate both approaches safely',
        'Use the cheapest herbs available without consultation',
    ...
    },
    {
      ...
      options: [
        'It produces fewer plants',
        'It allows rapid multiplication of disease-free, genetically identical plants',
        'It requires more land space',
        'It takes longer than seed propagation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Only ex-situ conservation',
        'In-situ (wild nurseries) combined with ex-situ (tissue culture and seed banks)',
        'Only tissue culture'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'It claims traditional medicine is always better',
        'It shows that 74% of pharmaceutical drugs have herbal origins and herbs have scientific validation',
        'It rejects all conventional medicine',
        'It claims herbs work instantly'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Micropropagation (produces identical clones)',
        'Seed banks (preserve diverse genetic material)',
        'Callus culture (undifferentiated cells)',
    ...
    },
    {
      ...
      options: [
        'It would eliminate all traditional medicine',
        'It would ensure consistent quality and safety for the 80% of the world\'s population using herbal medicines',
        'It would make herbs too expensive globally',
        'It would standardize only Western herbs'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It proves herbs are better than all drugs',
        'It supports the fact that many modern drugs originate from plants and herbs have scientific validity',
        'It means traditional medicine is now obsolete',
        'It shows herbs work without scientific research'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It would replace all traditional knowledge',
        'It could provide sustainable, quality-controlled herbal materials while supporting local economies',
        'It would require communities to abandon traditional methods',
        'It would only benefit urban populations'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Single herbs are useless',
        'Traditional medicine\'s use of herb combinations may be scientifically valid',
        'All single herbs should be avoided',
        'Herb mixtures are always dangerous'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Complete prohibition of harvesting',
        'Wild nurseries combined with controlled cultivation programs',
        'Only laboratory tissue culture',
        'Destruction of all wild populations'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It proves all herbs are dangerous',
        'It shows that herbs, like all medicines, can have side effects and interactions requiring professional guidance',
        'It means herbs should never be used',
        'It proves conventional drugs are safer'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It eliminates the need for natural neem populations',
        'It can supply reintroduction programs for depleted wild populations',
        'It reduces the neem plant\'s medicinal value',
        'It creates genetically inferior plants'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Herbs don\'t help mental health',
        'The holistic, personal approach may address both physical and emotional aspects of health',
        'Only conventional medicine treats mental health',
        'Personal relationships are irrelevant in medicine'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It eliminates the need for standardization',
        'It increases demand for regulated, quality-controlled herbal products worldwide',
        'It means herbs should remain unregulated',
        'It focuses standardization only on expensive herbs'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Wild plants should be eliminated',
        'Tissue culture could be used for both conservation and pharmaceutical production',
        'Wild plants are inferior to cultured plants',
        'Conservation efforts should focus only on wild populations'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Herbs are too effective',
        'Lack of standardization and regulation alongside proven efficacy',
        'Herbs are too expensive',
        'Conventional doctors oppose all herbs'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It would increase plant populations',
        'It could reduce wild populations, increasing reliance on conservation techniques like tissue culture',
        'It would make all plants extinct immediately',
        'It would have no effect on medicinal plants'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Herbs can interfere with conventional medications',
        'Conventional drugs are always superior',
        'Herbs never interact with other substances'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Neem has no commercial value',
        'Neem is a source of compounds for developing new drugs and pesticides',
        'Neem only grows in laboratories',
        'Neem is not used in modern medicine'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It prioritizes economics over ecology',
        'It establishes cultivation areas near natural habitats for endangered species, combining protection with sustainable economic use',
        'It eliminates all economic uses of plants',
    ...
    },
    {
      ...
      options: [
        'Traditional knowledge should be discarded',
        'Scientific research validates and builds upon traditional herbal knowledge',
        'Traditional knowledge is always superior to science',
        'The two approaches are completely separate'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It eliminates the need for diabetes research',
        'It could lead to improved treatments combining traditional knowledge with modern biotechnology',
        'It means traditional bitter leaf is ineffective',
        'It focuses only on expensive treatments'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Medicinal plants are always more expensive',
        'Rising costs of imported medicines make accessible local alternatives crucial for healthcare equity',
        'Medicinal plants require expensive equipment',
    ...
    },
    {
      ...
      options: [
        'It rejects scientific approaches',
        'It shows how traditional uses (fever, digestion, malaria) are validated by scientific research',
        'It claims traditional uses are invalid',
        'It focuses only on scientific research'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only protecting existing habitats',
        'Only developing new technologies',
        'Combining habitat protection, community education, sustainable harvesting, and advanced technologies like tissue culture',
        'Eliminating all human use of medicinal plants'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'It proves standardization is unnecessary',
        'It supports the need for standardization to ensure consistent therapeutic effects from identified compounds',
        'It means ginger should only be used in raw form',
        'It eliminates the need for ginger in medicine'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'By replacing conventional medicine entirely',
        'By providing holistic care that addresses both medical and emotional needs of patients',
        'By making conventional medicine obsolete',
    ...
    },
    {
      ...
      options: [
        'It means herbal medicine is unreliable',
        'It emphasizes that scientific understanding of herbs continues to evolve with new research',
        'It means traditional knowledge is always wrong',
        'It rejects all scientific research on herbs'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Which medicinal plant is traditionally used for digestive problems and is known scientifically as Zingiber officinale?',
      options: [
        'Garlic (Ayuu)',
        'Ginger (Ata-ile)',
        'Lemon grass (Koko-Oja)',
    ...
    },
    {
      ...
      options: [
        ...
        'To maintain diverse plant collections and develop propagation protocols',
        'To destroy invasive species',
        'To grow only decorative plants'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Why might tissue culture be particularly valuable for conserving rare medicinal plants in Nigeria?',
      options: [
        'It eliminates the need for traditional farming',
        'It provides year-round production and disease-free plants without seasonal limitations',
        'It makes plants too expensive for local use',
        'It only works in laboratory conditions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It will increase plant populations worldwide',
        'It could reduce wild populations, making conservation techniques more important',
        'It will have no effect on medicinal plants',
        'It will make all plants extinct immediately'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They completely replace natural habitats',
        'They establish cultivation areas near natural habitats for endangered species',
        'They focus only on commercial production',
        'They destroy natural ecosystems'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It makes herbs more expensive',
        'It ensures consistent quality and safety for international markets',
        'It eliminates traditional preparation methods',
        'It focuses only on pharmaceutical companies'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'If a researcher discovers that tissue culture can enhance the medicinal compounds in bitter leaf, what broader implication does this have for pharmaceutical development?',
      options: [
        'It eliminates the need for wild bitter leaf',
        'It could create standardized, high-potency herbal medicines for diabetes treatment',
        'It means tissue culture is better than traditional use',
        'It reduces the plant\'s effectiveness'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It would eliminate all traditional methods',
        'It could provide standardized plant material for consistent traditional preparations',
        'It would make herbs too potent',
        'It would require abandoning traditional knowledge'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only tissue culture in laboratories',
        'Only protecting existing habitats',
        'Combining in-situ conservation (habitat protection) with ex-situ methods (tissue culture, seed banks)',
        'Eliminating all human use of plants'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'It would eliminate traditional healers',
        'It could create pathways for traditional healers to work alongside conventional healthcare with quality assurance',
        'It would make traditional healing illegal',
        'It would favor only pharmaceutical companies'
      ],
      correctAnswer: 1,

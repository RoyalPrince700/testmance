// Quiz data for GNS 311 Chapter 1: The Structure of Science, Scientific Methods and Revolution
// Questions generated from the actual chapter content

export const gns311Chapter1Quiz = {
  title: 'GNS 311 Chapter 1: The Structure of Science, Scientific Methods and Revolution',
  description: 'Test your understanding of scientific methods, structure of science, and scientific revolutions based on Chapter 1 content',
  courseCode: 'GNS 311',
  chapterTitle: 'The Structure of Science, Scientific Methods and Revolution',
  passingScore: 70,
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        'Empirical, Theoretical, Relational',
    ...
    },
    {
      ...
      options: [
        ...
        'Empirical laws are based on observations and do not explain why, while theoretical laws are based on theory and explain why',
    ...
    },
    {
      ...
      options: [
        'The microscope',
        'The first thermometer (air thermometer)',
        'The telescope',
        'The barometer'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Planets orbit in elliptical paths',
        'Planets are stationary',
        'Planets orbit randomly'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'The heart is stationary',
        'The heart has no function'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Science can make all decisions',
        'Science provides information, but humans make the decisions',
        'Science is always accurate',
        'Science works instantly'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Why is it inadequate to define science using only one of its three components?',
      options: [
        'It would be too simple',
        'It would be misleading and incomplete',
        'The other components are not important',
        'Science only needs products'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Empirical laws are mathematical, theoretical are not',
        'Empirical laws describe what happens without explaining why, theoretical laws explain why',
        'Empirical laws are proven, theoretical are not',
    ...
    },
    {
      ...
      options: [
        'He didn\'t understand mathematics',
        'His method focused on collecting and classifying information',
        'Mathematics was not invented yet',
        'He preferred pure observation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Pure experimentation without theory',
        'Mathematical reasoning and deduction',
        'Observation without mathematics',
    ...
    },
    {
      ...
      options: [
        'He rejected both Bacon and Descartes',
        'He integrated experimentation with mathematical reasoning',
        'He focused only on mathematics',
        'He emphasized pure observation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They proved the Earth was flat',
        'They showed the Earth moves and the sun is the center of the solar system',
        'They discovered new planets',
        'They measured Earth\'s diameter'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They are used for planning satellite orbits',
        'They are the simplest laws',
    ...
    },
    {
      ...
      options: [
        'They replaced universities',
        'They filled the gap left by declining universities',
        'They controlled all scientific research',
        'They only met socially'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Doubting all scientific findings',
        'Unwillingness to believe superstitions',
    ...
    },
    {
      ...
      options: [
        'A body of unchanging knowledge',
        'A human enterprise studying nature\'s orderliness',
    ...
    },
    {
      ...
      options: [
        ...
        'Science has limitations as a method of knowing',
        'Humans prefer to make their own decisions',
        'Science is too slow'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'If a scientist discovers a new phenomenon but cannot explain why it occurs, what type of law might they formulate?',
      options: [
        'Theoretical law',
        'Empirical law',
        'Mathematical law',
    ...
    },
    {
      ...
      options: [
        'When they have existing mathematical theories to test',
        'When they need to collect data first',
        'When they want to avoid mathematics',
        'When they prefer observation over theory'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Both emphasize simple, elegant explanations over complex ones',
        'Parsimonious means expensive explanations',
        'Occam\'s Razor rejects simplicity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They made science more expensive',
        'They created systematic peer review and knowledge sharing',
        'They replaced individual scientists',
        'They slowed down scientific progress'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It proves science is not objective',
        'It shows science involves human values and ethics alongside objectivity',
        'It means science is purely subjective',
        'It rejects the need for objectivity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Modify or abandon the theory',
        'Prove the theory was always wrong',
        'Stop doing science in that area'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Products came before processes',
        'Processes led to new products',
        'They developed independently',
        'Processes replaced products'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Scientists are lazy',
        'Science assumes orderliness in nature and needs systematic investigation',
        'Science rejects surprises',
        'Scientists prefer slow work'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It means no facts are reliable',
        'It shows science is always tentative and subject to revision',
        'It means scientists make up facts',
        'It rejects the need for facts'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It provides a framework (products, processes, ethics) to categorize and sequence learning',
    ...
    },
    {
      ...
      options: [
        'He only created products',
        'He only developed processes',
        'He used new processes (telescopes, systematic observation) to create new products (heliocentric model)',
        'He rejected both products and processes'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Science would be more efficient',
        'Scientific knowledge would be less reliable and more biased',
        'Science would progress faster',
        'Ethics are not important in science'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They demonstrate the enduring power of careful observation and mathematical analysis',
        'Modern science ignores old laws',
    ...
    },
    {
      ...
      options: [
        'It means science is not objective',
        'It acknowledges that science requires human creativity, values, and enterprise alongside objectivity',
        'It rejects objectivity entirely',
        'It means anyone can do science without training'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It requires existing theories',
        'It starts with systematic data collection before forming generalizations',
        'It needs mathematical formulas first',
    ...
    },
    {
      ...
      options: [
        'It showed the body is mechanical',
        'It replaced emotion-based understanding with evidence-based circulatory system knowledge',
        'It proved ancient medicine was completely wrong',
        'It eliminated the need for doctors'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Science provides the knowledge foundation that enables technological achievements',
        'Technology drives all scientific progress',
    ...
    },
    {
      ...
      options: [
        'To change fields frequently',
        'To remain open to new ideas and modify understanding based on new evidence',
        'To reject established knowledge',
    ...
    },
    {
      ...
      options: [
        'It means science is only for certain cultures',
        'It emphasizes that scientific knowledge transcends cultural and national boundaries',
        'It rejects international cooperation',
        'It means all scientists must work in one country'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Scientists should celebrate failure',
        'Failed experiments provide valuable data and learning opportunities',
        'Scientists should avoid all risks',
    ...
    },
    {
      ...
      options: [
        'It showed one method was superior',
        'It combined complementary approaches for more powerful science',
        'It rejected both older methods',
        'It proved both methods were wrong'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Curiosity is more important than objectivity',
        'Curiosity motivates the entire scientific enterprise',
        'Curiosity replaces the need for methods',
        'Curiosity is not essential for scientists'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Scientists ignore laws',
        'Scientific laws describe nature\'s patterns, not rules to follow like legal laws',
        'Laws are suggestions only',
        'Nature can break scientific laws'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It made science less human',
        'It institutionalized human cooperation, peer review, and ethical standards',
        'It eliminated individual scientists',
        'It made science more competitive'
      ],
      correctAnswer: 1,

// Quiz data for GNS 311 Chapter 4: Conservation of Conventional and Renewable Energy Sources and Their Conversion Techniques
// Questions generated from the actual chapter content

export const gns311Chapter4Quiz = {
  title: 'GNS 311 Chapter 4: Conservation of Conventional and Renewable Energy Sources and Their Conversion Techniques',
  description: 'Test your understanding of energy conservation, renewable energy sources, biomass conversion, and sustainable energy practices based on Chapter 4 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Conservation of Conventional and Renewable Energy Sources and Their Conversion Techniques',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'According to the chapter, what is the fundamental principle underlying energy conservation?',
      options: [
        'Energy can be created from nothing',
        'Energy cannot be created or destroyed, only converted',
        'Energy always decreases in quality',
    ...
    },
    {
      ...
      options: [
        'Environmental protection through reduced emissions',
        'Economic benefits from lower energy costs',
        'Energy security and reduced import dependence',
        'Complete elimination of energy needs'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'It provides energy 24 hours a day',
        'It is free and abundant in sunny climates',
    ...
    {
      question: 'What is the title of Chapter 4 in GNS 311?',
      options: [
    ...
    {
      question: 'Why does the chapter emphasize that energy conservation is about more than just turning off lights?',
      options: [
        'Because lights use very little energy',
        'Because it involves understanding energy resources and using them wisely',
        'Because lights are not the main energy consumers',
        'Because lights cannot be turned off'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'High fuel costs',
        'No fuel costs and land can be used for farming',
    ...
    },
    {
      ...
      options: [
        ...
        'It requires specific geological conditions',
        'It needs ocean access',
        'It works only at high altitudes'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Plants absorb CO₂ during growth, balancing combustion emissions',
        'It uses carbon capture technology',
        'It converts carbon to other elements'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It produces biogas through microbial breakdown without oxygen',
        'It only works with plant material',
        'It creates electricity directly'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Biofuels taste better than food',
        'Competition between food crops and energy crops for land and resources',
        'Biofuels reduce food nutritional value',
        'Biofuels spoil faster than food'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They use mirrors to concentrate sunlight',
        'They directly convert sunlight into electricity using semiconductors',
        'They store heat in batteries'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Ocean tides follow predictable astronomical patterns',
        'It has government regulation',
        'It uses backup batteries'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'If a power plant converts chemical energy in coal to electricity with 35-40% efficiency, what happens to the remaining 60-65% of the energy?',
      options: [
        'It disappears completely',
        'It is converted to mechanical energy only',
        'It becomes waste heat and other unusable forms',
    ...
    },
    {
      ...
      options: [
        'They produce more energy per acre',
        'They use non-food biomass sources like agricultural waste',
    ...
    },
    {
      ...
      options: [
        'Conservation means using less energy, saving means storing energy',
        'Conservation involves efficient use and sustainable practices, not just reduction',
        'Saving energy is temporary, conservation is permanent',
    ...
    },
    {
      ...
      options: [
        ...
        'Its emissions are much lower and it has minimal environmental impact compared to fossil fuel mining and combustion',
        'It requires no land use',
    ...
    },
    {
      ...
      options: [
        'It makes all energy sources equally valuable',
        'It favors sources that can provide consistent, 24/7 power like nuclear, coal, and hydro',
    ...
    },
    {
      ...
      options: [
        'High energy density makes transportation easier',
        'Low energy density requires more volume for same energy content',
        'Energy density has no effect on transportation',
        'All energy sources have the same density'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It creates multiple valuable products including bio-oil and biochar',
        'It requires less biomass',
        'It works faster'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Electric vehicles use no energy',
        'They demonstrate energy conversion from electricity to mechanical energy with high efficiency',
        'They eliminate the need for energy conservation',
        'They only work with renewable energy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It converts viscous vegetable oils into less viscous biodiesel suitable for diesel engines',
        'It increases energy content',
    ...
    },
    {
      ...
      options: [
        ...
        'Biomass can utilize existing agricultural waste and create rural jobs',
        'Biomass requires imported technology',
        'Biomass has higher environmental impact'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Energy losses through friction and heat dissipation prevent 100% efficiency',
        'They require too much initial energy',
    ...
    },
    {
      ...
      options: [
        'They grow faster than dedicated energy crops',
        'They avoid the food vs. fuel conflict by using waste products',
        'They produce more energy per acre',
    ...
    },
    {
      ...
      options: [
        ...
        'CSP can provide thermal energy for industrial processes and electricity storage',
        'CSP works at night',
        'CSP requires less land'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Efficiency improvements reduce overall energy demand and emissions',
        'Efficiency has no effect on climate change',
        'Efficiency increases emissions',
        'Efficiency only affects costs'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Extensive safety systems, regulatory requirements, and long construction times',
        'Nuclear plants are small',
        'Nuclear technology is outdated'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It converts organic waste into biogas while reducing methane emissions from landfills',
    ...
    },
    {
      ...
      options: [
        ...
        'Hydro provides reliable baseload power when solar/wind are intermittent',
        'Hydro is easier to install',
        'Hydro produces more energy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It contains high concentrations of desirable gases like CO and H₂',
        'It is liquid at room temperature',
        'It contains no impurities',
        'It is easier to transport than natural gas'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'It measures how much money is made from energy sales',
        'It compares energy produced to energy invested in production',
        'It calculates environmental impact',
        'It determines energy prices'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It affects the types of products produced (bio-oil vs. biochar vs. syngas)',
        'It determines how much biomass is needed',
        'It affects the color of the products',
        'It determines the cost of the process'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Algae grow too slowly',
        'High water requirements and harvesting costs make it expensive',
        'Algae produce too much energy',
        'Algae cannot be grown in ponds'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Buildings should be made smaller',
        'Energy-efficient design, insulation, and smart systems reduce overall energy demand',
        'Buildings should not use electricity',
        'Buildings should be made of glass'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Biomass plants are cheaper to build',
        'Biomass provides local economic benefits and utilizes local waste',
        'Solar farms produce more energy',
        'Biomass works at night'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Conservation reduces security by using less energy',
        'Conservation reduces dependence on imported energy sources',
        'Conservation increases energy imports',
        'Conservation has no effect on security'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It uses sugars from biomass more efficiently for ethanol production',
        'It produces more biochar',
        'It works without microorganisms'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It is less reliable than solar',
        'It provides continuous baseload power like hydroelectricity',
        'It stops at night like solar',
        'It varies with wind like wind energy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They eliminate all waste',
        'They reduce landfill use while generating electricity from waste',
        'They make waste disappear',
        'They only work with organic waste'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It releases more CO₂ than it absorbs',
        'Land use changes for biomass production can release stored carbon',
        'It produces methane during digestion',
        'It requires fossil fuels for processing'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Battery electric vehicles convert electrical energy to mechanical energy more efficiently than internal combustion engines',
        'All vehicles have the same efficiency',
        'Efficiency is not important for transportation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It uses no water',
        'It doesn\'t require large dams that flood ecosystems',
        'It produces no electricity',
        'It requires ocean water'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Gasification is cheaper',
        'Producer gas can be used for multiple applications beyond just heat',
        'Gasification requires less biomass',
        'Gasification is safer'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It only considers production costs',
        'It evaluates environmental impact from production to disposal',
        'It ignores environmental effects',
        'It only measures energy output'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Wind energy is intermittent and requires backup power sources',
        'Wind turbines make noise',
        'Wind requires too much land'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It uses food crops',
        'It can use agricultural waste and dedicated energy crops that don\'t compete with food',
        'It produces less ethanol',
    ...
    },
    {
      ...
      options: [
        'Industries should stop production',
        'Industries can reduce energy use through process optimization and waste heat recovery',
        'Industries should use more energy',
        'Industries are not important for energy conservation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It converts manure and crop residues into biogas while producing nutrient-rich digestate for fertilizer',
        'It only works with food waste',
        'It requires no microorganisms'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They are both cheap',
        'Solar provides peak daytime power while hydro provides reliable baseload and peaking power',
        'They work together to increase costs',
        'One makes the other less effective'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Biomass energy always degrades soil',
        'Biochar from pyrolysis can improve soil fertility and water retention',
        'Biomass requires fertile soil to grow',
        'Biomass has no effect on soil'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It measures how long it takes for an energy system to produce as much energy as was used to build it',
        'It calculates profit from energy sales',
        'It measures environmental impact',
        'It determines maintenance costs'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Tidal energy is cheaper',
        'Tidal energy provides predictable power without visual impact',
        'Wind energy is more reliable',
        'Tidal energy works in all locations'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Algae grow slowly',
        'Algae can produce oil without competing for arable land or freshwater',
        'Algae require fertile soil',
        'Algae need food crops'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Conservation efforts are less important than new energy sources',
        'Energy efficiency improvements can significantly reduce greenhouse gas emissions at lower cost than new supply',
        'Conservation has no effect on climate change',
        'Conservation increases emissions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The time it takes for energy prices to decrease',
        'The time required for a renewable energy system to produce the same amount of energy used in its construction and installation',
        'The warranty period for energy equipment',
        'The time between energy production peaks'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It uses wave energy to generate electricity',
        'It harnesses the temperature difference between surface and deep ocean water to drive a heat engine',
        'It converts tidal movements into electrical power',
        'It uses ocean currents to turn turbines'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Storing water in reservoirs for irrigation',
        'Pumping water uphill during low demand and releasing it downhill through turbines during high demand',
        'Using hydroelectric dams for flood control',
        'Converting water pressure into steam'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They enable real-time monitoring, demand response, and optimal energy distribution to reduce waste',
        'They only monitor electricity usage',
    ...
    },
    {
      ...
      options: [
        'Storing carbon in batteries',
        'Capturing CO₂ emissions from power plants and storing them underground to reduce climate impact',
        'Capturing solar energy as carbon',
    ...
    },
    {
      ...
      options: [
        'Developing countries should only use fossil fuels',
        'Distributed renewable energy systems and microgrids can provide electricity to remote areas more cost-effectively than extending national grids',
        'Energy access is not a priority in developing countries',
        'Only large-scale power plants can solve energy access problems'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It replaces the need for renewable energy',
        'It reduces overall energy demand, making renewable energy deployment more manageable and cost-effective',
        'It increases energy consumption',
        'It only applies to conventional energy sources'
      ],
      correctAnswer: 1,

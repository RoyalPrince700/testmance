// Quiz data for GNS 311 Chapter 2: Philosophical Problems and Scientific Explanations
// Questions generated from the actual chapter content

export const gns311Chapter2Quiz = {
  title: 'GNS 311 Chapter 2: Philosophical Problems and Scientific Explanations',
  description: 'Test your understanding of philosophy of science, scientific explanations, and their models based on Chapter 2 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Philosophical Problems and Scientific Explanations',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    {
      question: 'The word "science" is derived from which Latin word?',
      options: [
        'Scientia',
        'Scientiae',
        'Scientiarum',
    ...
    },
    {
      ...
      options: [
        ...
        'Prediction, Control, Explanation',
    ...
    },
    {
      ...
      options: [
        'D-N is inductive, IS is deductive',
        'D-N is deductive and entails the explanandum, while IS is inductive and confers high probability',
        'D-N uses statistics, IS uses logic',
    ...
    },
    {
      ...
      options: [
        ...
        'It is unable to account for judgments of explanatory relevance',
        'It only works for physics',
        'It is too simple'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Empirical verification and inductive reasoning',
    ...
    },
    {
      ...
      options: [
        ...
        'By using measuring devices and reducing human involvement',
        'By avoiding all measurements',
        'By using only theoretical models'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'The relevance of various factors as a comparative concept',
    ...
    },
    {
      ...
      options: [
        ...
        'The assumptions, foundations, methods, and implications of science',
    ...
    {
      question: 'Which of the following is NOT one of the four definitions of science mentioned in the chapter?',
      options: [
        'Science as knowledge',
        'Science as systematic study',
        'Science as ordered body of knowledge',
        'Science as technological invention'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Study of scientific history',
        'Critical discussion of scientific developments',
        'Mathematical modeling of science',
    ...
    },
    {
      ...
      options: [
        ...
        'Injecting philosophical notions',
    ...
    },
    {
      ...
      options: [
        ...
        'To reduce human involvement and increase objectivity',
        'To replace scientists entirely',
        'To create more data than needed'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Which philosophy of science examines questions like "What is a number?" and "Why does 1+1=2 make sense?"',
      options: [
        'Philosophy of Biology',
        'Philosophy of Mathematics',
        'Philosophy of Physics',
    ...
    },
    {
      ...
      options: [
        'Deductive starts with general principles, inductive starts with specific observations',
        'Deductive is certain, inductive is probabilistic',
        'Deductive is used in mathematics, inductive in science',
        'Deductive explains past events, inductive predicts future events'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'The preference for left or right-handed molecules in biological systems',
        'Quantum mechanical explanations of chemical bonding',
        'The relationship between chemical concepts and reality'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To discuss scientific topics',
        'To examine scientific assumptions',
        'To inject philosophical notions into science',
    ...
    },
    {
      ...
      options: [
        ...
        'Philosophy of science has limited practical effect on scientists\' work',
        'Scientists never contribute to philosophy of science',
        'Philosophy of science replaces scientific practice'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Critically analyze: If the D-N model requires every explanation to cite a law that entails the explanandum, how does this limitation affect explanations of historical events like the extinction of dinosaurs?',
      options: [
        'It makes such explanations impossible since we cannot rerun the experiments',
        'It requires finding laws that perfectly predict such unique events',
        'It eliminates the need for auxiliary hypotheses in explanations',
        'It proves that historical explanations cannot be scientific'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The probability becomes too high to measure',
        'The requirement of maximal specificity becomes problematic',
        'Rare events cannot have high probability explanations',
        'The model only works for common phenomena'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The model ignores causality entirely',
        'The model focuses on logical structure over causal mechanisms',
        'Causal relations are incompatible with deductive logic',
        'The model only works for non-causal phenomena'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'How to measure distance with rulers',
        'The nature of space and time themselves',
        'How to calibrate clocks accurately',
    ...
    },
    {
      ...
      options: [
        'Mathematical proofs are too long',
        'How can we ascertain that a mathematical proof is correct',
        'Mathematical proofs require too much computation',
        'There are too many different proof methods'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It eliminates the need for laws in explanations',
        'It provides a comparative framework for assessing relevance',
        'It makes all explanations equally relevant',
        'It replaces statistical analysis with logical deduction'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Scientists cannot agree on what constitutes good data',
        'The calibration of instruments depends on the very theories being tested',
        'There are too many variables to control in experiments',
        'Statistical analysis requires too much background knowledge'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Empirical verification requires certainty, induction provides probability',
        'Empirical methods are deductive, induction is inductive',
        'Verification requires observation, induction requires generalization',
        'They are completely compatible and reinforcing'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Chemistry studies completely different phenomena',
        'Chemistry has its own fundamental concepts like nucleophiles and electrophiles',
        'Chemical reactions cannot be explained quantum mechanically',
        'Chemistry only studies macroscopic properties'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'We cannot test every possible action-reaction pair',
        'The law only applies to mechanical systems',
        'Induction cannot prove universal laws',
        'The law has been disproven by quantum mechanics'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'The Critical Method',
        'The Original Philosophical Method',
        'All methods create equal tension'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'That science can achieve absolute certainty',
        'That the best explanation is likely to be true',
        'That all explanations are equally valid',
        'That explanation is not a goal of science'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It explains why some molecules rotate light',
        'It questions whether symmetry in chemistry is fundamental or contingent',
        'It proves that life requires specific molecular arrangements',
        'It shows that chemical evolution is impossible'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Philosophy of psychology is more empirical',
        'Cognitive science focuses on neural mechanisms',
        'Philosophy examines conceptual foundations, cognitive science studies implementation',
    ...
    },
    {
      ...
      options: [
        'Machines cannot interpret data',
        'Humans must still design and interpret the instruments',
        'Objectivity eliminates the need for theory',
        'Scientific knowledge becomes completely certain'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Philosophy of particular sciences applies general philosophical methods to specific domains',
        'General philosophy of science renders particular philosophies obsolete',
        'Particular philosophies are more important than general philosophy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It cannot explain statistical phenomena',
        'It ignores the role of causal mechanisms in explanation',
        'It requires too much mathematical knowledge',
        'It only works for simple phenomena'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'How to perform calculations faster',
        'What notation to use for equations',
        'How to teach mathematics better'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'It makes all experiments circular',
        'It shows that theories can never be definitively tested',
        'It proves that scientists are biased',
    ...
    },
    {
      ...
      options: [
        ...
        'Determining what constitutes a "factor" in complex systems',
        'It cannot handle probabilistic phenomena',
        'Statistical relevance is not objective'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s completely true - philosophy has no practical value',
        'It overlooks how philosophy clarifies scientific concepts and assumptions',
        'It ignores that many scientists contribute to philosophy',
    ...
    {
      question: 'Given the D-N model\'s requirement for laws that entail the explanandum, analyze why this creates insurmountable difficulties for explaining mental phenomena like consciousness in philosophy of psychology.',
      options: [
        'Mental phenomena cannot be quantified',
        'There are no universal laws governing mental states',
        'Consciousness violates the principle of causality',
        'Mental explanations require statistical rather than deductive approaches'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The model handles asymmetry through comparative relevance',
        'Statistical relevance is inherently symmetrical',
        'The model cannot distinguish between causes and effects',
        'Asymmetry requires temporal ordering beyond statistical analysis'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Quantum mechanics is too complex for practical chemistry',
        'Chemical concepts like "bond" may not be fully reducible to quantum descriptions',
        'Molecular structures cannot be observed directly',
        'Quantum calculations are computationally infeasible'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Quantum mechanics proves objectivity is impossible',
        'Observer effects can be statistically averaged out',
        'The paradox shows that quantum interpretations are metaphysical, not empirical',
        'Objectivity requires abandoning quantum mechanics'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'The regress cannot be broken - all science is circular',
        'The regress is broken by philosophical fiat',
        'The regress is broken by practical consensus among scientists',
        'The regress proves science is not empirical'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Mathematical proofs become probabilistic',
        'Certain mathematical truths are unprovable within formal systems',
        'Mathematics can no longer be used in science',
        'Scientific laws become uncertain'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Evolution cannot explain adaptation without teleology',
        'Teleological language in biology is merely metaphorical',
        'Mechanistic explanations cannot account for apparent design',
        'Teleology proves intelligent design'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Complex systems have too many variables to specify',
        'Maximal specificity eliminates probabilistic explanations',
        'Complex systems lack stable statistical regularities',
        'All variables in complex systems are equally relevant'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'IBE proves scientific theories are true',
        'IBE only provides pragmatic justification, not truth',
        'Prediction success is independent of theory truth',
        'IBE eliminates the need for empirical testing'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Quantum mechanics proves causality is an illusion',
        'Determinism and indeterminacy are compatible at different levels',
        'Causal explanations must be abandoned in physics',
        'Quantum effects are too small to affect macroscopic causality'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Philosophy has no authority over scientific methods',
        'Metaphysical frameworks are empirically testable',
        'Philosophy can legitimately critique but not dictate scientific assumptions',
        'Scientific autonomy requires rejecting all philosophy'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Observations are always fallible',
        'The future might differ from the past',
        'Induction requires circular reasoning',
        'Scientific laws are inherently probabilistic'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The mind-body problem proves dualism is true',
        'Philosophy can establish the correct theory of consciousness',
        'The mind-body problem shows consciousness is beyond scientific explanation',
        'Different philosophical approaches suggest different explanatory frameworks'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Statistical relevance is completely objective and context-independent',
        'Statistical relevance depends on the explainer\'s background knowledge',
        'Statistical relevance eliminates the need for causal understanding',
        'Statistical relevance only works for quantitative data'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Chemical kinds are purely conventional',
        'Chemical kinds exist independently of human classification',
        'Chemical explanations are inherently subjective',
        'The debate has no impact on chemical practice'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The methods are equally valid for all scientific contexts',
        'They represent a progression from descriptive to prescriptive philosophy',
        'The Original Method is the most scientific approach',
        'The methods are incompatible with each other'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Measuring devices eliminate human interpretation entirely',
        'Human interpretation undermines all scientific objectivity',
        'Objectivity exists in degrees and requires careful calibration',
        'Measuring devices prove science is completely objective'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Mathematical truths are known independently of experience',
        'Mathematics and science are completely separate',
        'Mathematical knowledge requires empirical verification'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Theory choice is completely irrational',
        'Underdetermination proves all theories are equally valid',
        'Theory choice requires non-empirical criteria like simplicity',
        'Underdetermination only affects fringe theories'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Quantum mechanics makes classical physics obsolete',
        'Classical physics provides the limit of quantum mechanics for large systems',
        'The correspondence principle shows quantum mechanics is wrong',
        'Classical and quantum explanations are fundamentally incompatible'
      ],
      correctAnswer: 1,

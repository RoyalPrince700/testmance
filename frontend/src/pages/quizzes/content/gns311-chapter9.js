// Quiz data for GNS 311 Chapter 9: Global Threat of Counterfeit Medicines
// Questions generated from the actual chapter content

export const gns311Chapter9Quiz = {
  title: 'GNS 311 Chapter 9: Global Threat of Counterfeit Medicines',
  description: 'Test your understanding of counterfeit medicines, their definitions, magnitude, implications, and anti-counterfeit measures based on Chapter 9 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Global Threat of Counterfeit Medicines',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    // EASY QUESTIONS (Basic Recall)
    {
      question: 'What is the title of Chapter 9 in GNS 311?',
      options: [
    ...
    },
    {
      ...
      options: [
        'Any chemical substance used in industry',
        'A single chemical substance that forms the active ingredient of medicine',
        'Any substance that affects the body',
    ...
    },
    {
      ...
      options: [
        ...
        'Prostitution, narcotics, terrorism, and arms trade',
        'Banking and finance',
    ...
    },
    {
      ...
      options: [
        'A type of counterfeit medicine',
        'A pharmaceutical company',
        'A mobile authentication system for verifying genuine medicines',
        'A government agency'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Automated Pharmaceutical Inventory',
        'Approved Pharmaceutical Item'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Has proper directions for use',
        'Is colored to conceal damage'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'To make packaging look attractive',
        'To provide visible evidence when tampered with',
    ...
    },
    {
      ...
      options: [
        'Overt features only',
        'Covert, forensic, and tactile features',
        'Overt, covert, and forensic features',
        'Visual, audio, and tactile features'
      ],
      correctAnswer: 2,
    ...
    {
      question: 'Why is it important to distinguish between "drugs" and "medicines" according to the chapter?',
      options: [
        'Drugs are associated with illicit substances while medicines are pharmaceutical preparations',
        'They have the same meaning',
        'Drugs are only for animals',
        'Medicines are only traditional remedies'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Based on price',
        'Based on composition and packaging combinations',
        'Based on manufacturer location',
    ...
    },
    {
      ...
      options: [
        'They reduce military budgets',
        'Profits from counterfeit medicines fund organized criminal and terrorist operations',
    ...
    },
    {
      ...
      options: [
        'Poverty eliminates counterfeit medicines',
        'Poverty drives people to seek cheaper medicines from unregulated outlets where counterfeits are common',
        'Poor countries have fewer counterfeit medicines',
        'Poverty improves medicine quality'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Effective drugs become outdated',
        'Cheap effective drugs become useless due to drug resistance',
        'New drugs replace old ones',
        'Drugs expire naturally'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Scientific knowledge transcends cultural boundaries',
        'All scientists must work in one country',
        'Ethics vary by culture',
        'Scientific methods are culture-specific'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'They make drugs cheaper',
        'They lack adequate human and financial resources to enforce quality standards',
        'They over-regulate the industry',
        'They increase drug prices'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It involves bilateral and multilateral agreements with organizations like WHO, Interpol, and WCO',
        'It focuses only on national solutions',
    ...
    },
    {
      ...
      options: [
        'It showed counterfeit medicines can cause complex health crises',
        'It proved all heparin is counterfeit',
        'It eliminated counterfeit medicines',
        'It improved drug quality worldwide'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'They copy packaging designs',
        'They infringe on patents and industrial design affecting trademark owners',
        'They improve innovation',
        'They create new medicines'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They increase counterfeiting',
        'They replace government regulation',
        'They empower consumers and raise awareness about counterfeit threats',
        'They focus only on manufacturers'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'They make medicines cheaper',
        'They can identify even the slightest differences in formulation',
        'They replace visual inspection',
        'They are used only for packaging'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'How does the chapter\'s mathematical classification of counterfeit medicines help in understanding the scope of the problem?',
      options: [
        'It shows counterfeits are simple to identify',
        'It demonstrates the various combinations of fake packaging with different ingredient scenarios',
        'It proves all counterfeits are identical',
    ...
    },
    {
      ...
      options: [
        ...
        'It reduces drug safety, efficacy, quality, strength, or purity (as per Philippines definition)',
        'It costs the same as genuine medicine',
    ...
    },
    {
      ...
      options: [
        'Counterfeits reduce poverty',
        'Poverty creates demand for cheap counterfeits, while corruption prevents effective enforcement',
        'Corruption improves drug quality',
        'Poverty has no relation to counterfeits'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It makes detection difficult, reducing the risk of getting caught',
        'It increases enforcement',
        'It improves medicine quality'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They promote peace',
        'When combined with poverty, they contribute to political instability and social unrest',
        'They strengthen governments',
        'They improve economic conditions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Free trade zones eliminate counterfeits',
        'Lack of control by exporting countries and lax drug regulation in free trade zones allow counterfeiters to operate freely',
        'Free trade zones have stricter controls',
        'They are unrelated'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To increase costs',
        'To create unique chemical fingerprints that counterfeiters cannot easily replicate',
        'To reduce quality',
    ...
    },
    {
      ...
      options: [
        ...
        'They cause loss of confidence in healthcare systems, professionals, and treatments',
        'They improve medical outcomes',
    ...
    },
    {
      ...
      options: [
        'It encourages more counterfeits',
        'Failed experiments provide valuable data and learning opportunities for improving detection methods',
        'It accepts counterfeit medicines',
    ...
    },
    {
      ...
      options: [
        'Counterfeits prevent resistance',
        'Ineffective counterfeit antimicrobials lead to microbial resistance by allowing pathogens to survive',
        'Counterfeits improve antibiotic effectiveness',
        'They are unrelated'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To allocate budgets, provide institutional support, and ensure speedy disposal of counterfeit cases',
    ...
    },
    {
      ...
      options: [
        ...
        'They cause financial wastage, loss of productivity due to illness, increased hospital stays, and tax revenue losses',
        'They strengthen economies',
        'They reduce healthcare costs'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It has no effect',
        'Advanced technology helps counterfeiters replicate sophisticated packaging, but also enables better detection methods',
        'It only helps counterfeiters',
        'It only helps detection'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Counterfeit medicines are part of illegal economic activities alongside prostitution, narcotics, terrorism, and arms trade',
        'They improve global economies',
    ...
    },
    {
      ...
      options: [
        ...
        'The true extent of the problem requires comprehensive global research and data collection',
    ...
    },
    {
      ...
      options: [
        'They respect universal standards',
        'They undermine universal access to quality medicines by providing substandard products globally',
        'They improve universal healthcare',
    ...
    },
    {
      ...
      options: [
        'It complicates solutions',
        'It involves education, training, NGO/CBO participation, and consumer empowerment for comprehensive solutions',
        'It focuses only on government',
        'It excludes consumers'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They help achieve SDGs',
        'They threaten SDG 2 (Zero Hunger) and SDG 3 (Good Health and Well-being) by compromising food security and health',
        'They are unrelated to SDGs',
    ...
    },
    {
      ...
      options: [
        'Single solutions work',
        'The problem simultaneously addresses causes of food insecurity and health crises requiring coordinated approaches',
        'Simple solutions are sufficient',
        'Integration complicates solutions'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They cause malnutrition, illness, and death that reduce productive workforce and educational attainment',
        'They strengthen human capital',
        'They are unrelated to development'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They increase counterfeiting',
        'They enable tracking of medicines from manufacture to patient, preventing diversion and counterfeiting',
        'They complicate supply chains',
    ...
    },
    {
      ...
      options: [
        ...
        'Poor waste disposal of counterfeit medicines can contaminate water and soil, affecting environmental and public health',
    ...
    },
    {
      ...
      options: [
        ...
        'Because profits from this lucrative trade provide financial resources for criminal and terrorist organizations',
        'To minimize the issue',
        'Because profits are small'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They improve access for all',
        'They disproportionately affect vulnerable populations who cannot afford genuine medicines, widening health disparities',
        'They ensure equal access',
        'They have no effect on equity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Counterfeiters constantly evolve their methods, requiring ongoing technological advancement to stay ahead',
    ...
    },
    {
      ...
      options: [
        'They strengthen global health',
        'They represent a global threat that transcends national borders, requiring international cooperation and coordinated responses',
        'They are contained nationally',
    ...
    },
    {
      ...
      options: [
        'They are simple problems',
        'They involve treatment failure, adverse reactions, drug resistance, and loss of confidence in healthcare systems simultaneously',
        'They have single effects',
    ...
    },
    {
      ...
      options: [
        ...
        'They discredit legitimate scientific research and pharmaceutical development by associating genuine science with counterfeit failures',
        'They promote scientific innovation',
        'They are unrelated to science'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Different national standards create loopholes that counterfeiters exploit across borders',
        'It weakens regulations',
        'It is unnecessary'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They discourage investment in research and development by undermining legitimate pharmaceutical markets',
        'They increase R&D funding',
        'They are unrelated'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Drug resistance and health crises created today will affect treatment options and health outcomes for future generations',
        'They improve future health',
        'They are short-term problems'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They strengthen ethics',
        'Healthcare professionals face ethical dilemmas when patients receive counterfeit treatments, questioning the value of their expertise',
        'They are unrelated to ethics',
        'They improve professional standards'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Consumers cannot help',
        'Educated consumers can identify and avoid counterfeit medicines, creating market pressure against illicit products',
        'It increases counterfeiting',
        'Consumers prefer counterfeits'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They affect all countries equally',
        'They improve global equity',
        'They disproportionately affect developing countries with weaker regulatory systems and higher poverty rates'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'The problem involves manufacturers, regulators, healthcare providers, consumers, and governments working together',
        'Individuals have no role',
    ...
    },
    {
      ...
      options: [
        'They improve knowledge sharing',
        'They undermine trust in medical knowledge and scientific evidence, hindering knowledge transfer between professionals and patients',
        'They enhance education',
        'They are unrelated to knowledge'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It encourages more counterfeiting',
        'It demonstrates commitment and deters potential counterfeiters by showing swift and certain consequences',
        'It weakens enforcement',
        'It is unnecessary'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They drive both illicit technological innovation (counterfeiting methods) and legitimate innovation (detection technologies)',
        'They stop all technology development',
    ...
    },
    {
      ...
      options: [
        ...
        'One counterfeit medicine can lead to treatment failure, drug resistance, hospital admission, lost productivity, and broader economic impacts',
        'They have minimal effects',
        'They improve social outcomes'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They support evidence-based approaches',
        'They undermine evidence-based medicine by providing treatments that fail despite scientific evidence of efficacy',
        'They strengthen evidence-based medicine',
        'They are compatible with evidence-based approaches'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They complicate solutions',
        'They enable information sharing, coordinated enforcement, and mutual legal assistance across borders',
    ...
    },
    {
      ...
      options: [
        ...
        'To provide visible evidence when packaging has been tampered with',
    ...
    },
    {
      ...
      options: [
        'Counterfeits prevent drug resistance',
        'Ineffective counterfeit treatments allow pathogens to survive and develop resistance to both counterfeit and genuine antibiotics',
        'Counterfeits strengthen antibiotic effectiveness',
        'Drug resistance is unrelated to counterfeits'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It shows counterfeits are simple to identify',
        'It demonstrates various combinations of fake packaging with different ingredient scenarios',
        'It proves all counterfeits are identical',
        'It eliminates the need for testing'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Poverty eliminates counterfeit medicines',
        'Poverty drives demand for cheaper medicines from unregulated outlets where counterfeits are common',
        'Poor countries have fewer counterfeit problems',
        'Poverty improves medicine quality'
      ],
      correctAnswer: 1,

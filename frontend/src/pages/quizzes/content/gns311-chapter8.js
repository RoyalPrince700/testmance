// Quiz data for GNS 311 Chapter 8: Food Production and Preservation for Food Security: The Place of Cooperatives in Nigeria
// Questions generated from the actual chapter content

export const gns311Chapter8Quiz = {
  title: 'GNS 311 Chapter 8: Food Production and Preservation for Food Security: The Place of Cooperatives in Nigeria',
  description: 'Test your understanding of food security, food preservation methods, and the role of cooperatives in sustainable food production based on Chapter 8 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Food Production and Preservation for Food Security: The Place of Cooperatives in Nigeria',
  passingScore: 70,
  timeLimit: 30, // minutes
  questions: [
    // EASY QUESTIONS (Basic Recall)
    {
      question: 'According to the FAO definition, what is food security?',
      options: [
        'Having enough food to eat every day',
        'Physical, social and economic access to sufficient, safe and nutritious food for an active and healthy life',
    ...
    },
    {
      ...
      options: [
        'When food becomes too expensive',
        'Adverse changes in the quality of food due to biological reactions, autolysis, or physical reactions',
        'When food is stored for too long',
        'When food loses its color'
      ],
      correctAnswer: 1,
    ...
    {
      question: 'Which region has the most severe food insecurity problems according to the chapter?',
      options: [
        'North America',
        'Europe',
    ...
    },
    {
      ...
      options: [
        ...
        'Natural enzymes breaking down food components',
        'Pest damage',
        'Temperature changes'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To inactivate enzymes before canning/freezing',
    ...
    },
    {
      ...
      options: [
        'They use the same temperatures',
        'Pasteurization destroys pathogens but not all microbes, sterilization destroys all microorganisms',
        'Sterilization is for liquids only',
        'Pasteurization takes longer'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s cheaper',
        'It retains shape, size, and volatile components',
        'It takes less time',
    ...
    },
    {
      ...
      options: [
        ...
        'To manipulate gas composition and retard respiration',
    ...
    {
      question: 'If a farmer wants to preserve fish for long-term storage using traditional methods, which combination would be most effective?',
      options: [
        'Just drying in the sun',
        'Smoking followed by salting',
        'Freezing without packaging',
        'Pickling in water only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'HTST is cheaper and preserves more nutrients',
        'UHT is only for juice',
        'HTST takes longer but is safer',
    ...
    },
    {
      ...
      options: [
        ...
        'Direct food aid and nutrition interventions',
    ...
    },
    {
      ...
      options: [
        'Refrigeration only',
        'Pasteurization combined with refrigeration',
        'Drying the dairy',
        'Smoking the dairy'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It increases GDP directly',
        'It affects workforce productivity and political stability',
        'It reduces import costs only',
    ...
    },
    {
      ...
      options: [
        'It adds radioactive material',
        'It uses ionizing radiation without radioactivity',
        'It requires high temperatures',
        'It only works on liquids'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Water provides the medium for enzymatic and microbial reactions',
        'They are heavier',
    ...
    },
    {
      ...
      options: [
        'Refrigeration without preservatives',
        'Smoking combined with chemical preservatives',
        'Drying only',
    ...
    },
    {
      ...
      options: [
        'It focuses on single solutions',
        'It recognizes that poverty has multiple causes requiring simultaneous approaches',
        'It ignores poverty as a cause',
        'It only addresses immediate hunger'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s cheaper',
        'It manipulates gas composition to reduce respiration and spoilage',
        'It increases fruit size',
        'It changes fruit color'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Foreign solutions are ineffective',
        'Locally conceived solutions are more sustainable and appropriate',
        'International aid is unavailable',
        'Local solutions are cheaper'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It requires high temperatures',
        'It uses beneficial microorganisms to create inhibitory conditions',
        'It completely destroys all microbes',
        'It only works on milk products'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only refrigeration',
        'Proper harvesting, immediate cooling, and controlled atmosphere storage',
        'Just chemical preservatives',
        'Drying everything'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Women don\'t work in agriculture',
        'Women often lack access to resources and decision-making in food systems',
        'Men are better farmers',
    ...
    },
    {
      ...
      options: [
        'It uses lower doses',
        'It provides shelf-stable products like commercial sterility',
        'It only works on vegetables',
        'It requires refrigeration after treatment'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Chemical preservatives only',
        'Heat treatment (blanching or pasteurization)',
        'Drying only',
        'Packaging only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Food secure people are more likely to vote',
        'Food insecurity creates fertile ground for conflict when combined with poverty',
        'Governments provide all food',
        'Political stability has no relation to food'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It involves intermittent heating to destroy spores',
        'It only works on liquids',
        'It\'s faster than sterilization'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s cheaper',
        'It provides better protection against mold in high humidity',
        'It takes less time',
    ...
    },
    {
      ...
      options: [
        ...
        'They enhance keeping quality and maintain nutritional value',
        'They make food radioactive',
        'They are only for coloring'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Food can be available but inaccessible due to poverty or distribution issues',
        'Access is only about transportation',
    ...
    },
    {
      ...
      options: [
        'It makes packages heavier',
        'It controls gas composition around the food',
        'It changes food taste',
    ...
    },
    {
      ...
      options: [
        ...
        'Inadequate sterilization or sealing',
        'Too much cooling',
        'Wrong can size'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It\'s cheaper',
        'It retains original shape and volatile components for quality-critical applications',
        'It\'s faster',
        'It requires no equipment'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Ignore failed preservation attempts',
        'Learn from failed experiments to improve techniques',
        'Never experiment with new methods',
        'Accept all spoilage as inevitable'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Higher water activity always prevents spoilage',
        'Lower water activity reduces microbial growth potential',
        'Water activity has no effect on spoilage',
        'Only temperature affects water activity'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They enable collective action and resource sharing for sustainable production',
        'They replace individual farming',
        'They only focus on marketing'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'LTLT uses higher temperatures',
        'LTLT uses lower temperatures for longer times (63-65°C, 30 min)',
        'LTLT is only for milk',
        'They are identical'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It ensures consistent supplies over time and space',
        'It means food lasts forever',
        'It prevents food from being transported'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It requires living organisms to create preservation conditions',
        'It only works on living foods',
        'It prevents all life forms',
    ...
    },
    {
      ...
      options: [
        'Monthly food aid distributions',
        'Agricultural improvement and education training',
        'Emergency imports only',
    ...
    },
    {
      ...
      options: [
        ...
        'They describe natural patterns rather than rules to follow',
        'They are suggestions only',
        'Nature can break them'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It ensures nutritional adequacy for health and productivity',
        'Quality only affects taste',
    ...
    },
    {
      ...
      options: [
        ...
        'Refrigeration slows metabolism while modified atmosphere reduces respiration',
        'Refrigeration replaces the need for gas control',
    ...
    },
    {
      ...
      options: [
        ...
        'It provides environmental control and contamination prevention',
        'It only makes food look attractive',
    ...
    },
    {
      ...
      options: [
        'They provide free land',
        'They enable collective purchasing of inputs and marketing of produce',
        'They replace government agricultural programs',
        'They only focus on credit provision'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It enhances nutritional value and creates unique flavors',
    ...
    },
    {
      ...
      options: [
        ...
        'Training in proper harvesting and immediate processing techniques',
        'Importing foreign foods',
        'Reducing food prices artificially'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Single solutions are too expensive',
        'Food insecurity is multi-dimensional requiring simultaneous interventions',
        'Integrated approaches are more complex',
        'Single solutions work better in Nigeria'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Freezing only',
        'Drying followed by proper storage',
        'Smoking without drying',
        'Pickling in vinegar alone'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They only prepare food',
        'They are primary food producers and household nutrition managers',
        'They have no role in agriculture',
        'They only consume food'
      ],
      correctAnswer: 1,

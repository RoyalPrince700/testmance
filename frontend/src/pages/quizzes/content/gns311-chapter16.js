// Quiz data for GNS 311 Chapter 16: Geomorphology of Africa
// Questions generated from the actual chapter content

export const gns311Chapter16Quiz = {
  title: 'GNS 311 Chapter 16: Geomorphology of Africa',
  description: 'Comprehensive test of your understanding of geomorphology, geological processes, and physical features of Africa based on Chapter 16 content',
  courseCode: 'GNS 311',
  chapterTitle: 'Geomorphology of Africa',
  passingScore: 70,
  timeLimit: 50, // minutes (extended due to more questions)
  questions: [
    {
      question: 'What is Geomorphology?',
      options: [
        'The study of animal behavior',
        'The scientific discipline concerned with surface and features of the earth',
    ...
    },
    {
      ...
      options: [
        ...
        'The movement of hot magma from generation point to surface',
        'The cooling of lava',
    ...
    },
    {
      ...
      options: [
        ...
        'Partial melting of crust and mantle at 100-300 km depth',
    ...
    },
    {
      ...
      options: [
        ...
        'The destructive processes that change physical and chemical characteristics of rocks',
    ...
    },
    {
      ...
      options: [
        'Wind erosion',
        'Water erosion',
        'Gravity-controlled processes on slopes',
        'Ice erosion'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Wind erosion',
        'Processes involving flowing water',
        'Ice erosion',
        'Gravity erosion'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They are too wide',
        'They are steeper than natural slopes',
        'They have more vegetation',
        'They are lower than natural slopes'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Southern margins',
        'Western margins',
        'Northern regions (approximately 300m)',
        'Eastern margins'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'A mountain system from Morocco to Tunisia',
    ...
    },
    {
      ...
      options: [
        'Areas with flowing rivers',
        'Areas with no rivers flowing to sea',
        'Areas with many lakes',
        'Areas with coastal access'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'A mountain range',
        'A dramatic depression extending from Red Sea to Mozambique',
        'A river system',
        'A desert region'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Margins with active volcanoes',
        'Margins with earthquakes',
        'Margins void of earthquake, volcanoes, and young mountain belts',
        'Margins with frequent landslides'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Quiet geological margins',
        'Margins associated with convergent plates',
        'Margins without earthquakes',
        'Margins without mountains'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'A deep ocean trench',
        'A giant undersea mountain range',
        'An ocean current',
        'A continental shelf'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Deep ocean trenches',
        'Conical mountains on the sea floor',
        'Ocean currents',
        'Continental shelves'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Rock type only',
        'Climate only',
        'Climate, topography, rock structure, rock type, and time',
        'Topography only'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'A mountain range',
        'A transition zone between Sahara and tropical south',
        'A river system',
        'A coastal desert'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Tectonic activities over 600 million years',
        'Sedimentation only',
        'Weathering only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Higher rainfall and vegetation cover',
        'Rift valley system running north-south with associated tectonic activities and volcanism',
        'Sedimentation from major river systems',
        'Glacial activity during Pleistocene'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They increase pressure, preventing melting; this creates stable continental platforms',
        'They lower melting point by facilitating solid-liquid transitions; this enables volcanism along plate boundaries and mantle plumes, contributing to African highlands',
        'They evaporate, creating dry conditions; this promotes desert formation',
        'They crystallize minerals; this forms sedimentary rocks'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'All African margins are active with frequent earthquakes and volcanoes',
        'Passive margins lack tectonic activity while active margins at convergent boundaries feature Mid-Oceanic Ridges, seamounts, and guyots formed by plate divergence',
        'African coasts are entirely passive with no ocean floor features',
        'Plate tectonics has no influence on African coastal morphology'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'All African rivers flow to the sea, creating extensive coastal plains',
        'Vast areas have no rivers reaching the sea due to tectonic uplift and arid climates; water either evaporates or infiltrates, creating internal drainage and influencing desert formation',
        'African hydrography is dominated by glacial meltwater systems',
        'Endorheism has no relationship to Africa\'s geomorphology'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It creates uniform magma compositions across all African volcanic regions',
        'Early-forming minerals remove elements from magma, enriching remaining melt in silica/aluminum; this creates felsic magmas that form granitic intrusions and volcanic highlands',
        'It prevents magma evolution and maintains primitive compositions',
        'Fractional crystallization only occurs in oceanic settings, not continental Africa'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Weathering is uniform across Africa due to consistent controls',
        'Climate dictates weathering type/rate, topography controls energy, rock structure/type determines resistance, and time allows cumulative effects; together they create variations from Sahara desert landscapes to tropical rainforest terrains',
        'Only climate controls weathering in Africa',
        'Time is the only important weathering control in African contexts'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Tectonic uplift creates mountains, erosion reduces them to peneplains; northern Africa (300m) shows higher relief than southern/western margins due to differential tectonic activity and erosion rates',
        'Erosion has completely flattened Africa with no remaining relief variations',
        'Tectonic activities are recent and have not influenced African relief',
        'Peneplains only form in humid tropical regions of Africa'
      ],
      correctAnswer: 0,

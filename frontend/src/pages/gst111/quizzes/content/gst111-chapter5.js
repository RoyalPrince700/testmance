// Quiz data for GST 111 Chapter 5: Parts of Speech - Modifiers and Qualifiers
// Questions generated from the actual chapter content

export const gst111Chapter5Quiz = {
  title: 'GST 111 Chapter 5: Parts of Speech - Modifiers and Qualifiers',
  description: 'Comprehensive test of modifiers, qualifiers, adjectives, adverbs, and their grammatical functions in English',
  courseCode: 'GST 111',
  ...
  questions: [
    {
      question: 'What is the primary function of modifiers in English language?',
      options: [
        'To create new words',
        'To give additional information or details',
    ...
    },
    {
      ...
      options: [
        'A type of noun',
        'A word or phrase that precedes adverbs or adjectives to increase or decrease quality',
        'A punctuation mark',
        'A verb tense'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The cake is delicious absolutely',
        'The cake is absolutely delicious',
        'Absolutely the cake is delicious',
        'The absolutely cake is delicious'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Modifiers are words, qualifiers are phrases',
        'Modifiers describe, qualifiers intensify or limit',
        'Modifiers come before nouns, qualifiers after verbs',
        'Modifiers are adjectives, qualifiers are adverbs'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Create new words',
        'Add precision and nuance to descriptions',
        'Change verb tenses',
        'Connect sentences'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The extremely beautiful painting hangs on the wall',
        'The painting beautiful extremely hangs on the wall',
        'Extremely the beautiful painting hangs on the wall',
        'The painting hangs on the wall extremely beautiful'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'To enhance or limit the meaning of words',
        'To create rhythm in sentences',
    ...
    },
    {
      ...
      options: [
        ...
        'Its function to describe or give details',
        'Its length (modifiers are longer)',
    ...
    },
    {
      ...
      options: [
        ...
        'Beautifully the singer performed'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'They have similar but slightly different intensities',
        'One is formal, the other informal',
        'They modify different parts of speech'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They make writing too formal',
        'They can make statements vague or imprecise',
        'They are grammatically incorrect',
        'They change the meaning completely'
      ],
      correctAnswer: 1,

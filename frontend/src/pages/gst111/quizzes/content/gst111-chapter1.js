// Quiz data for GST 111 Chapter 1: Speaking Skills
// Questions generated from the actual chapter content

export const gst111Chapter1Quiz = {
  title: 'GST 111 Chapter 1: Speaking Skills',
  description: 'Comprehensive test of English phonological systems, speech sounds, stress, intonation, and practical application for Nigerian learners',
  courseCode: 'GST 111',
  chapterTitle: 'Speaking Skills',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'How many letters does English have in its alphabet compared to its speech sounds?',
      options: [
        '26 letters, 26 speech sounds',
        '26 letters, 36 speech sounds',
        '26 letters, 44 speech sounds',
        '44 letters, 26 speech sounds'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Word stress, sentence stress, and emphatic stress',
        'Primary stress, secondary stress, and weak stress',
        'Loud stress, soft stress, and medium stress',
        'Initial stress, medial stress, and final stress'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Segmental phonation process',
        'Suprasegmental stress patterns',
        'Mother-tongue articulatory habits affecting consonant clusters',
        'Oro-nasal process confusion'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Place the tongue tip between the teeth with light air friction',
        'Vibrate the vocal cords strongly while keeping the tongue low',
        'Block the airstream completely then release it',
        'Round the lips and raise the back of the tongue'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Silent consonant awareness',
        'Past tense marker pronunciation',
        'Schwa sound application',
    ...
    },
    {
      ...
      options: [
        'Reduce stress on content words in neutral statements',
        'Apply primary stress to the first syllable of polysyllabic words',
        'Use rising intonation for declarative sentences',
        'Eliminate secondary stress entirely'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Only airstream process for the initial /s/',
        'Airstream, phonation, and oro-nasal processes for all sounds',
        'Just phonation process for the voiced sounds',
        'Only oro-nasal process for the nasal sounds'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Lack of awareness of digraph pronunciation patterns',
    ...
    },
    {
      ...
      options: [
        'On "ed" because it\'s the first syllable',
        'On "ca" because it contains the most complex vowel sound',
        'On "tion" because it\'s a derivational suffix requiring stress',
        'On "u" because it\'s the vowel closest to the word root'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Vowel sound determines article choice, not spelling',
        'Stress pattern modification',
        'Intonation tune selection'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Teach velar plosive production',
        'Train dental fricative articulation with tongue tip placement',
        'Practice bilabial nasal sound formation',
        'Learn alveolar lateral production'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Falling tune because it\'s a statement',
        'Rising tune because it seeks confirmation of understanding',
        'Level tune because it\'s a tag question',
        'No intonation change needed'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'No secondary stress is needed',
        'Primary stress on "graph", secondary on "pho"',
        'Equal stress on all syllables',
        'Primary stress on "to", secondary on "pho"'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Simultaneous production of all three sounds',
        'Sequential but overlapping articulation from alveolar to dental to alveolar',
        'Voiced-voiceless-voiced sequence',
        'Complete blockage followed by gradual release'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Memorization of individual words',
        'Training in dental fricative production with minimal pairs practice',
        'Elimination of all voiced consonants',
        'Focus on vowel sounds only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It signals finality and authority, preventing misinterpretation as a question',
        'It reduces the volume of the speaker\'s voice',
        'It indicates the speaker is unsure'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Consonant cluster simplification',
        'Stress placement on antepenultimate syllable',

// Quiz data for GST 111 Chapter 8: Reading Comprehension Strategies
// Questions generated from the actual chapter content

export const gst111Chapter8Quiz = {
  title: 'GST 111 Chapter 8: Reading Comprehension Strategies',
  description: 'Comprehensive test of reading comprehension skills, strategies, and techniques for effective reading',
  courseCode: 'GST 111',
  chapterTitle: 'Reading Comprehension Strategies',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'What does "reading comprehension" mean according to the chapter?',
      options: [
        'Reading words aloud with proper pronunciation',
        'Getting meaning out of what is read',
        'Reading as fast as possible without understanding',
    ...
    },
    {
      ...
      options: [
        'Translation - giving information in another form',
        'Interpretation - understanding major ideas and relationships',
        'Extrapolation - determining consequences and effects',
        'Memorization - storing information for later recall'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'Intensive reading covers more text; extensive reading examines text closely',
        'Intensive reading examines text closely for full meaning; extensive reading covers large amounts quickly',
        'Intensive reading is for pleasure; extensive reading is for study',
        'Intensive reading uses subvocalization; extensive reading avoids it'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Analyzing a poem for literary devices',
        'Reading a newspaper article quickly',
        'Studying a complex scientific paper in detail',
    ...
    },
    {
      ...
      options: [
        'Moving eyes back to re-read text',
        'Internal speech made when reading silently',
        'Recognizing words automatically without analysis',
    ...
    },
    {
      ...
      options: [
        ...
        'Going back to re-read already read text',
        'Moving eyes smoothly across the page',
    ...
    },
    {
      ...
      options: [
        'Poor eyesight',
        'Laziness - brain relies on ability to re-read later',
        'Too much subvocalization',
        'Small eye span'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Reading faster without comprehension',
        'Using a paper to cover already-read text',
        'Avoiding subvocalization completely',
    ...
    },
    {
      ...
      options: [
        'The ability to pronounce words correctly when reading aloud',
        'The ability to recognize written words correctly and effortlessly',
    ...
    },
    {
      ...
      options: [
        'Failure to recognize letters properly',
        'Faulty association of word meanings',
        'Inability to grasp author\'s attitude',
        'Reading too slowly'
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'Reading for relationships of thought',
    ...
    },
    {
      ...
      options: [
        'Detailed analysis of complex texts',
        'Facilitating familiarity with large amounts of reading material',
    ...
    },
    {
      ...
      options: [
        ...
        'It has a large role in translating visual to acoustic information',
        'It slows down reading speed significantly',
        'It is only useful for beginning readers'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'A type of reading comprehension skill',
        'Jerky eye movement when reading',
        'A method of word recognition',
        'A reading strategy for slow readers'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Faulty lexical association',
        'Grammatical relations breakdown',
        'Physical perception issue (letter recognition)',
        'Author\'s attitude misunderstanding'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Letter recognition failure',
        'Faulty lexical association',
        'Grammatical relations breakdown',
        'Logical principles failure'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Faulty lexical association',
        'Failure to recognize grammatical relations',
        'Author\'s attitude misunderstanding'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Correct application of vowel length rules',
        'Misunderstanding of silent letters in English',
        'Proper use of the schwa sound',
        'Accurate diphthong pronunciation'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Speed and fluency only',
        'Recognition rather than production of language features',
    ...
    },
    {
      ...
      options: [
        ...
        'Extensive reading trains speed reading skills',
        'Speed reading replaces extensive reading',
        'Extensive reading slows down speed reading'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Subvocalization',
        'Word recognition',
        'Eye regression due to lack of confidence',
        'Intensive reading'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Using only easy reading materials',
        'Memorizing all vocabulary words first',
        'Systematic instruction combined with regular practice',
        'Avoiding challenging texts entirely'
      ],
      correctAnswer: 2,

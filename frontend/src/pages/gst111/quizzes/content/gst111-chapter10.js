// Quiz data for GST 111 Chapter 10: Study Skills and Time Management
// Questions generated from the actual chapter content

export const gst111Chapter10Quiz = {
  title: 'GST 111 Chapter 10: Study Skills and Time Management',
  description: 'Comprehensive test of study skills and time management techniques for academic success, including goal setting, prioritization, and effective learning strategies',
  courseCode: 'GST 111',
  chapterTitle: 'Study Skills and Time Management',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'What is the most effective strategy for managing study time?',
      options: [
        'Studying for long hours without breaks',
        'Using a structured schedule with regular breaks',
    ...
    },
    {
      ...
      options: [
        'They make goals impossible to achieve',
        'They provide clear direction and measurability',
        'They eliminate the need for planning',
        'They focus only on short-term objectives'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'To deal with conventions and techniques for scholarly written work',
        'To focus on business correspondence only',
        'To teach poetry composition'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Brainstorming, Organizing, Publishing'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Ideas may crowd into your head or you may need more reading and thinking',
        'Skip to the conclusion first',
        'Focus only on key words'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Spending disproportionate time reading without starting',
    ...
    },
    {
      ...
      options: [
        'Assemble materials, develop outline, read topic, jot points, refer back, write opening paragraph',
        'Research, plan, write, edit, revise, publish',
        'Brainstorm, organize, draft, review, finalize, submit',
        'Read, think, outline, write, proofread, submit'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Arranging ideas in logical paragraphs',
    ...
    },
    {
      ...
      options: [
        ...
        'To set the tone and captivate the reader',
    ...
    },
    {
      ...
      options: [
        ...
        'Combining ideas into cohesive wholes',
        'Haphazardly combined sentences and ungrammatical expressions',
        'Following logical flow of thought'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'What am I communicating? What is the better way? What image/words for effect? Is expression good? Avoid digression? Remove preambles?',
        'Who is my audience? What is the topic? How long should it be? What format to use? How to structure it? What to include?',
        'How to start? What to write? How to end? What to edit? How to proofread? How to submit?',
        'What is the purpose? Who will read it? What is the deadline? How many pages? What sources to use? What format?'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Varied length, development, and organization',
        'All the same length and structure',
    ...
    },
    {
      ...
      options: [
        ...
        'To edit, review, and proofread the draft',
        'To write additional content',
    ...
    },
    {
      ...
      options: [
        ...
        'Appropriateness of ideas to the topic',
    ...
    },
    {
      ...
      options: [
        'Check topic appropriateness, remove unrelated content, edit/review/proofread, improve structure, spot mistakes, reduce errors',
        'Add more content, change topic, rewrite completely, add references, format properly, submit',
        'Read aloud, check grammar, verify sources, count words, format citations, print',
        'Share with friends, get feedback, revise based on comments, final check, submit, celebrate'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'It demands meticulous effort and commitment',
        'It costs money to practice',
        'It can only be done in classrooms'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'There is one universal set of rules for all essays',
        'There is no single universal set, but form and shape are necessary',
        'Essays should never have a specific form',
        'All essays must follow the same structure regardless of purpose'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only traditional libraries and books',
        'Internet and emerging AI platforms',
        'Only printed dictionaries',
        'Social media only'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Getting bogged down in reading and confused about starting',
    ...
    },
    {
      ...
      options: [
        'Free flow of thought from one level to another',
        'All paragraphs must be identical',
        'No need for logical progression',
        'Random organization of ideas'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'The writer ignores the audience',
        'Dual interaction and interface between writer and audience',
        'Only the writer matters',
        'Audience provides the content'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Better ways to ensure clear communication',
    ...
    },
    {
      ...
      options: [
        ...
        'Avoid it completely',
        'Use it to lengthen the essay',
        'Add it in the conclusion'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Matthew Arnold only',
        'Collinson (1986) Writing English',

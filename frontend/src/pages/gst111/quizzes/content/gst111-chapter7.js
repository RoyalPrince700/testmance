// Quiz data for GST 111 Chapter 7: Grammatical Words
// Questions generated from the actual chapter content

export const gst111Chapter7Quiz = {
  title: 'GST 111 Chapter 7: Grammatical Words',
  description: 'Comprehensive test of grammatical words including prepositions, conjunctions, articles, auxiliary verbs, and pronouns',
  courseCode: 'GST 111',
  chapterTitle: 'Grammatical Words',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'What are grammatical words also known as?',
      options: [
        'Content words',
        'Lexical words',
        'Function words',
    ...
    },
    {
      ...
      options: [
        'Two verbs',
        'Nouns, pronouns, or phrases to other words',
        'Two adjectives',
    ...
    },
    {
      ...
      options: [
        ...
        'They join items of equal grammatical status',
        'They always come at the beginning of sentences',
        'They can only join words, not clauses'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'It becomes dependent and incomplete',
        'It can stand alone',
        'It becomes a noun clause'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Only before plural nouns',
        'Only before uncountable nouns'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To carry the main meaning',
        'To provide grammatical meaning (tense, mood, voice)',
        'To replace nouns',
        'To show location'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Questions',
        'Possession',
        'Mutual actions or relationships',
        'Emphasis'
      ],
      correctAnswer: 2,

// Quiz data for GST 111 Chapter 9: Writing Skills
// Questions generated from the actual chapter content

export const gst111Chapter9Quiz = {
  title: 'GST 111 Chapter 9: Writing Skills',
  description: 'Comprehensive test of writing skills including essay composition, paragraph development, and effective written communication techniques',
  courseCode: 'GST 111',
  ...
  questions: [
    {
      question: 'What is the primary purpose of writing skills according to academic standards?',
      options: [
        'To entertain readers with creative stories',
        'To communicate ideas clearly and effectively',
        'To demonstrate grammatical knowledge',
        'To impress professors with complex vocabulary'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'How interesting it is to the writer',
        'How much information is available',
        'The assignment requirements and audience',
        'How easy it is to write about'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Phonetics studies sound production while phonology studies sound organization',
        'Phonology is the starting point and phonetics builds upon it',
    ...
    },
    {
      ...
      options: [
        'Any sound produced by the human speech organs',
        'A distinct sound that constitutes a difference in meaning',
        'The written symbol representing a sound',
        'A noise that has no linguistic meaning'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The first p is voiced while the second is voiceless',
        'The first p occurs in word-initial position before a vowel',
        'The second p is in a stressed syllable',
        'The first p is a different phoneme from the second'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Preparation, compression, release, voicing',
        'Articulators together, air held, sudden release, voicing/voicelessness',
        'Inhalation, compression, exhalation, vibration',
        'Tongue positioning, air flow, sound production, termination'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'By their voicing and aspiration',
        'By place and manner of articulation, and voicing',
        'By their frequency of occurrence',
        'By their position in words'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'They involve a glide from one vowel position to another',
        'They are produced with steady state articulation',
        'The first vowel is longer and louder than the second',
        'They are heard as single sounds despite the glide'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Oral consonants use the mouth, nasal use the nose',
        'Oral consonants are voiced, nasal are voiceless',
        'Oral consonants are plosives, nasal are fricatives',
        'Oral consonants are produced in front, nasal in back'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Aspiration (one is aspirated, one is not)',
        'Different voicing'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'They show greater constriction of the vocal tract',
        'They require less air',
    ...
    },
    {
      ...
      options: [
        'Phonetic difference only',
        'Phonological difference (meaning change)',
        'No difference',
    ...
    },
    {
      ...
      options: [
        'All English words begin with consonant clusters',
        'English has complex consonant clusters that many Nigerian languages lack',
        'Consonant clusters are always voiced',
        'Clusters can only occur word-medially, never initially'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'To create new words',
        'To represent speech sounds symbolically',
    ...
    },
    {
      ...
      options: [
        ...
        'The bundle of features that differentiate phonemes',
        'The physical properties of speech organs',
        'The number of sounds in a language'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It is the smallest sound unit',
        'It organizes phonemes into pronounceable units',
        'It determines meaning',
        'It is the largest sound unit'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Triphthongs have three vowel qualities articulated together',
        'Triphthongs are shorter than diphthongs',
        'Triphthongs are only found in English',
        'Triphthongs have no glide component'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'It never changes meaning by itself',
        'It is not produced by speech organs',
        'It cannot be heard'
      ],
      correctAnswer: 1,

// Quiz data for GST 111 Chapter 6: ICT in Modern Language Learning
// Comprehensive assessment of ICT tools, applications, and implications in language education

export const gst111Chapter6Quiz = {
  title: 'GST 111 Chapter 6: ICT in Modern Language Learning',
  description: 'Comprehensive assessment of Information and Communications Technology applications, tools, challenges, and benefits in modern language learning environments',
  courseCode: 'GST 111',
  chapterTitle: 'ICT in Modern Language Learning',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'What is the primary reason ICT is essential for both teachers and students in modern education?',
      options: [
        'It replaces traditional teaching methods completely',
        'It aligns with the current trend toward online learning',
        'It eliminates the need for physical classrooms',
        'It focuses only on technical skills development'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Technology such as computers, communication facilities and features that support teaching and learning',
    ...
    },
    {
      ...
      options: [
        'In the 1960s with the first computers',
        'In the past decade with multimedia resources and the Internet',
        'In the 1980s with personal computers',
        'In the 1990s with email communication'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'The capacity for rapid processing',
    ...
    },
    {
      ...
      options: [
        'It replaces teachers entirely',
        'It provides access to authentic materials and enhances learning opportunities',
    ...
    },
    {
      ...
      options: [
        ...
        'Only printed textbooks',
        'Traditional classroom lectures',
        'Physical libraries only'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Only group learning',
        'Only teacher-centered learning',
        'Personalized learning based on individual needs',
        'Only competitive learning'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'To enable real-time language instruction and conversation practice',
    ...
    },
    {
      ...
      options: [
        'It replaces all traditional materials',
        'It gives access to current and authentic materials like online newspapers and videos',
        'It focuses only on fictional content',
        'It eliminates the need for language practice'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'By requiring constant teacher supervision',
        'By allowing students to study anytime and anywhere according to their needs',
    ...
    },
    {
      ...
      options: [
        ...
        'Inadequate technological infrastructure and unreliable power sources',
        'Students preferring traditional methods',
        'Teachers having too much technical knowledge'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Teachers\' lack of technological competence',
        'Too much funding available',
        'Excessive internet speed'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Limited personal socio-cultural interaction',
    ...
    },
    {
      ...
      options: [
        'The space between digital devices',
        'Inequality where learners with more ICT access outperform those with less exposure',
        'The time difference in digital communication',
    ...
    },
    {
      ...
      options: [
        ...
        'Complete elimination of teacher roles',
    ...
    },
    {
      ...
      options: [
        'To replace all formal instruction',
        'To provide access to videos, TV shows, and user-generated content for language practice',
        'To focus only on written text',
        'To eliminate the need for pronunciation practice'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only local classroom instruction',
        'Language courses with video lectures, exercises, and peer interaction',
        'Only written assignments',
        'Only assessment without instruction'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'All students learn the same material at the same pace',
        'Adaptive technologies adjust curriculum based on individual student needs',
    ...
    },
    {
      ...
      options: [
        ...
        'Risk of undermining critical thinking and problem-solving skills',
    ...
    },
    {
      ...
      options: [
        ...
        'Temporary and adaptable nature of digital content',
        'High-speed processing only',
        'Fixed learning pathways'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Podcasts in Pidgin English, Hausa, Yoruba, and Igbo',
        'Only international English content',
        'Only written textbooks',
        'Only formal academic materials'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'To enhance learning opportunities and prepare students for a technology-driven world',
    ...
    },
    {
      ...
      options: [
        ...
        'Changed from traditional to facilitator and mediator roles',
        'Only providers of technical support',
        'Unchanged from traditional methods'
      ],
      correctAnswer: 1,

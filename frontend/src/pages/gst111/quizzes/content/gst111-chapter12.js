// Quiz data for GST 111 Chapter 12: Mood In Grammar
// Questions generated from the actual chapter content

export const gst111Chapter12Quiz = {
  title: 'GST 111 Chapter 12: Mood In Grammar',
  description: 'Comprehensive test of verb moods in English grammar including indicative, imperative, interrogative, conditional, and subjunctive moods',
  courseCode: 'GST 111',
  chapterTitle: 'Mood In Grammar',
  passingScore: 70,
  timeLimit: 0, // no time limit
  questions: [
    {
      question: 'How many main verb moods are there in English grammar?',
      options: [
        '3 verb moods',
        '4 verb moods',
        '5 verb moods',
    ...
    },
    {
      ...
      options: [
        ...
        'Using the 3rd person present singular without -s/-es',
    ...
    },
    {
      ...
      options: [
        'I suggest that he waits till tomorrow.',
        'I suggest that he wait till tomorrow.',
        'I suggest that he waiting till tomorrow.',
        'I suggest that he waited till tomorrow.'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Typically has no subject',
        'Formed with auxiliary verbs before the subject',
    ...
    },
    {
      ...
      options: [
        'They demanded that the manager explains the situation.',
        'They demanded that the manager explain the situation.',
        'The manager explained the situation clearly.',
        'Did the manager explain the situation?'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Wrong indicative form',
        'Missing subjunctive form',
        'Incorrect imperative structure',
        'Wrong interrogative word order'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Confusion between indicative and imperative forms',
        'Difficulty with subjunctive after verbs like "suggest" or "demand"',
        'Problems forming negative interrogatives',
        'Mixing conditional and subjunctive in "if" clauses'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'The committee recommends that the policy changes.',
        'The committee recommended that the policy changed.',
        'The committee will recommend that the policy change.',
        'The committee recommends that the policy will change.'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Change to indicative: "I wished I was more confident."',
        'Use subjunctive: "I wish I were more confident."',
        'Use conditional: "I wish I would be more confident."',
        'Use imperative: "Be more confident!"'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Indicative mood with inverted word order',
        'Imperative mood in conditional form',
        'Subjunctive mood with subject-verb inversion',
        'Interrogative mood in formal construction'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'From subjunctive to interrogative',
        'From conditional to subjunctive'
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Imperative becomes conditional: "Come here!" → "He asked that I come here."',
        'Indicative becomes subjunctive: "He comes." → "She said that he come."',
        'Interrogative becomes indicative: "Are you coming?" → "He asked if I was coming."',
    ...
    },
    {
      ...
      options: [
        'Change to imperative: "Resign immediately, manager!"',
        'Use subjunctive: "We insist that the manager resign immediately."',
        'Make it conditional: "We would insist that the manager resign."',
        'Change to interrogative: "Should the manager resign immediately?"'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Commands become indicative statements',
        'Direct imperatives translate to polite conditionals',
        'Verbal commands require subjunctive forms',
        'Question forms become imperative'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Indicative in the "if" clause, imperative in the main clause',
        'Subjunctive in the "if" clause, conditional in the main clause',
        'Interrogative in both clauses',
        'Imperative in the "if" clause, subjunctive in the main clause'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Change to imperative: "Take the medicine!"',
        'Use subjunctive: "The doctor suggested that she take the medicine."',
        'Make it conditional: "The doctor would suggest that she take the medicine."',
        'Change to interrogative: "Should she take the medicine?"'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'It sounds more polite and formal',
        'It expresses hypothetical rather than factual situations',
        'It allows for subject-verb inversion',
        'It creates distance from direct commands'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Indicative after wish: "I wish I am taller."',
        'Conditional after wish: "I wish I would be taller."',
        'Subjunctive after wish: "I wish I were taller."',
        'Imperative after wish: "I wish be taller!"'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Indicative mood for factual statements',
        'Imperative mood for requirements',
        'Subjunctive mood after expressions of necessity',
        'Conditional mood for possibilities'
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'A direct command to God',
        'A hypothetical negative wish',
        'A factual statement about God',
        'A question about divine will'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Come here and eat your food now.',
    ...
    },
    {
      ...
      options: [
        'Indicative mood confusion',
        'Progressive form misunderstanding',
        'Subjunctive mood error',
        'Imperative mood application'
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Formal proposals and recommendations',

          ...
          {!isAuthenticated ? (
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Link
                  to="/courses"
                  className="bg-teal-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-teal-600 transition-colors shadow-lg"
                >
                  Browse Courses
                </Link>
              </div>
              ...
              <div className="max-w-4xl mx-auto mt-16">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center shadow-sm">
                    ...
                    <div className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">1 day</div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Daily Streak</div>
                  </div>
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center shadow-sm">
                    <div className="text-3xl mb-2">🎖️</div>
                    <div className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">0</div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Badges Earned</div>
                  </div>
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center shadow-sm">
                    <div className="text-3xl mb-2">📊</div>
                    <div className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">#24</div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Leaderboard Rank</div>
                  </div>
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center shadow-sm">
                    <div className="text-3xl mb-2">✅</div>
                    <div className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">10 / 56</div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Topics Mastered</div>
                  </div>
                </div>
              </div>
            </>
